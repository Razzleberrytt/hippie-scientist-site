  ...
  return (
    <div className="card-premium p-5 sm:p-6">
      <div className="flex flex-wrap items-center gap-3">
        ...
        {style ? (
          <span className="rounded-full border border-brand-900/10 bg-white/80 px-3 py-1 text-xs font-semibold text-brand-800 dark:border-white/10 dark:bg-white/5 dark:text-brand-100">
            {style}
          </span>
        ) : null}
      </div>
