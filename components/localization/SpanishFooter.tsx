...
export default function SpanishFooter() {
  return (
    <footer className='border-t border-[var(--border-soft)] bg-[var(--surface-card-strong)]' lang='es'>
      <div className='mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:px-8 md:grid-cols-[1.2fr_1fr] lg:px-10'>
        <div>
          <Link href='/es/' className='inline-flex min-h-11 items-center gap-2 font-display text-lg font-semibold text-[var(--text-primary)]'>
