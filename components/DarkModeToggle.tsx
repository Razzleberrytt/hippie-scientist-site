...
const DARK_MODE_COPY: Record<SupportedLocale, DarkModeCopy> = {
  'en-US': {
    ...
    systemSuffix: ' (currently following system)',
    light: 'Light',
    dark: 'Dark',
  },
  es: {
    ...
    systemSuffix: ' (siguiendo el sistema)',
    light: 'Claro',
    dark: 'Oscuro',
  },
  'pt-BR': {
    ...
    systemSuffix: ' (seguindo o sistema)',
    light: 'Claro',
    dark: 'Escuro',
  },
  fr: {
  ...
  de: {
    ...
    systemSuffix: ' (folgt derzeit dem System)',
    light: 'Hell',
    dark: 'Dunkel',
  },
}
