 ...
 * Keep this after the page's direct answer and critical evidence/safety boundary.
 */
export default function SleepResearchNextActions() {
  return (
    ...
    >
      <h2
        id="sleep-research-next-actions-heading"
        className="text-xl font-semibold text-ink dark:text-[var(--text-primary)]"
      >
