        ...
        {INTEREST_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              className={`min-h-11 rounded-2xl border p-4 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--hs-gold)] focus-visible:ring-offset-2 ${
                active
