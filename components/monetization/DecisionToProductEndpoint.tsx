...
import SleepProblemSelector from '@/components/sleep/SleepProblemSelector'
...
export default async function DecisionToProductEndpoint({
  ...
  const isSleepDecisionEndpoint = trackingLocation === 'sleep-decision-endpoint'

  return (
    <>
      {isSleepDecisionEndpoint ? <SleepProblemSelector /> : null}
