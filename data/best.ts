...
const bestPageHrefOverrides: Record<string, string> = {
  ...
  adaptogens: '/guides/anxiety/best-adaptogens-for-stress/',
  'brain-fog': '/guides/supplements-for-brain-fog-and-fatigue',
  'non-melatonin-sleep': '/guides/sleep/best-supplements-for-sleep/',
  'falling-asleep': '/guides/sleep/best-supplements-for-sleep/',
  'staying-asleep': '/guides/sleep/best-supplements-for-sleep/',
