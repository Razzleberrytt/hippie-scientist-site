...
// trial at 12 reduced this phase from about 5m36s to about 4m40s. A measured
// trial at 16 was slightly slower, so trial 14 as the final bounded midpoint on
// the known 4-vCPU/16-GB hosted runner. Other hosts retain Next's default 8.
const staticGenerationMaxConcurrency = process.env.GITHUB_ACTIONS === 'true' ? 14 : 8
