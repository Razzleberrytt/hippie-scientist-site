...
To study these plants is to study humanity — our fears, dreams, and longing to know more. We don’t just use them — we walk with them.`}];function ks(){return F.jsxs("div",{className:"min-h-screen px-4 pt-20",children:[F.jsxs(Pr,{children:[F.jsx("title",{children:"Learn - The Hippie Scientist"}),F.jsx("meta",{name:"description",content:"Educational resources on psychoactive herbs and practices."})]}),F.jsxs(Ye.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8},className:"mb-12 text-center",children:[F.jsx("h1",{className:"text-gradient mb-4 text-5xl font-bold md:text-6xl",children:"🌿 The Hippie Scientist Codex"}),F.jsx("p",{className:"mx-auto max-w-3xl text-xl text-sand",children:"Welcome! Explore each topic below to deepen your understanding."})]}),F.jsx(Mr,{children:F.jsx(xs,{sections:bs})})]})}export{ks as default};
