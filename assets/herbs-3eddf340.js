import{j as r,m as c,r as s}from"./main-bcc93350.js";function o(n){var a,e,i="";if(typeof n=="string"||typeof n=="number")i+=n;else if(typeof n=="object")if(Array.isArray(n)){var t=n.length;for(a=0;a<t;a++)n[a]&&(e=o(n[a]))&&(i&&(i+=" "),i+=e)}else for(e in n)n[e]&&(i&&(i+=" "),i+=e);return i}function d(){for(var n,a,e=0,i="",t=arguments.length;e<t;e++)(n=arguments[e])&&(a=o(n))&&(i&&(i+=" "),i+=a);return i}const l={pink:"from-pink-600 via-fuchsia-500 to-pink-600 shadow-pink-500/40",blue:"from-sky-600 via-cyan-500 to-sky-600 shadow-cyan-500/40",purple:"from-purple-700 via-violet-600 to-purple-700 shadow-violet-600/40",green:"from-lime-600 via-emerald-500 to-lime-600 shadow-emerald-500/40",yellow:"from-amber-600 via-yellow-500 to-amber-600 shadow-amber-500/40",red:"from-rose-600 via-red-500 to-rose-600 shadow-red-500/40"};function g({label:n,variant:a="purple",className:e}){return r.jsx(c.span,{whileHover:{scale:1.05},className:d("inline-flex items-center rounded-full bg-gradient-to-br px-2 py-0.5 text-xs font-medium text-white shadow",l[a],e),children:n})}function p(n,a){const[e,i]=s.useState(()=>{try{const t=localStorage.getItem(n);return t?JSON.parse(t):a}catch{return a}});return s.useEffect(()=>{try{localStorage.setItem(n,JSON.stringify(e))}catch{}},[n,e]),[e,i]}const u=`[
  {
    "name": "Acacia confusa",
