...
]`;function a(e){try{return JSON.parse(`"${e}"`)}catch{return e}}function t(e){const n=a(e),i=n.toLowerCase();return i==="ayahuasca-additive"?"Ayahuasca":i==="sleep"?"Dream":i==="sedative"?"Sedation":/(intense|strong|powerful)/.test(i)?"🔥 Intensity":/visionary|psychedelic|hallucinogenic/.test(i)?"Visionary":n}function l(e){const n=t(e).toLowerCase();return/(toxic|caution|restricted|safe)/.test(n)?"Safety":/(brew|tea|smoke|smokable|oral|chew|snuff|ferment|tincture|capsule|decoction|seed|root|bark|flower|incense)/.test(n)?"Preparation":/(stimulant|euphoria|dream|sleep|sedat|vision|dissoci|cognit|anxiolytic|energy|hallucinogen|calming|pain relief)/.test(n)?"Effect":/(dmt|lsa|thc|alkaloid|maoi|caffeine|nicotine|muscimol|morphine|tryptamine)/.test(n)?"Chemistry":/(africa|america|europe|asia|amazon|andes|australia|brazil|mexico|peru|india|china|pacific|region|north|south|west|east)/.test(n)?"Region":"Other"}function m(e){return e==null?"":e<=1?"text-green-400":e===2?"text-yellow-300":"text-red-400"}function u(e){const n=t(e);return/toxic|restricted|caution/i.test(n)?"red":/safe/i.test(n)?"green":/stimulant|euphoria/i.test(n)?"pink":/dissoci|sedat/i.test(n)?"purple":/dream/i.test(n)?"blue":/cognitive/i.test(n)?"yellow":/brew|smok/i.test(n)?"blue":/oral|ferment/i.test(n)?"yellow":/ritual/i.test(n)?"green":"purple"}const r={"root bark":"root",bark:"root",tryptamine:"psychedelic",phenethylamine:"psychedelic",stimulants:"stimulant",stimulant:"stimulant",stim:"stimulant",stimulating:"stimulant",Stimulant:"stimulant",Stimulants:"stimulant",Stimulation:"stimulant","⚡ stimulant":"stimulant","☕ stimulant":"stimulant","⚠️ stimulating":"stimulant"};function c(e){const n=a(e).toLowerCase().trim();return r[n]||n}const d=o.replace(/NaN/g,"null"),s=JSON.parse(d);s.forEach(e=>{if(Array.isArray(e.tags)){const n=new Map;e.tags.forEach(i=>n.set(c(i),i)),e.tags=Array.from(n.values())}e.affiliateLink==null&&(e.affiliateLink="")});const f=s;export{s as a,l as b,c,a as d,r as e,f as h,t as n,m as s,u as t};
