const i=`[
  ...
  },
  {
    ...
    "category": "Ritual / Visionary",
    "effects": ["stimulation", "mild euphoria"],
    "mechanismOfAction": "Nicotine and nornicotine act on nicotinic acetylcholine receptors",
    "activeConstituents": [
      {
        "name": "nornicotine",
        "type": "alkaloid",
    ...
    "preparation": "Leaves chewed with ash as pituri",
    "dosage": "Small quid chewed",
    "onset": "5-10 min",
    "duration": "1-2 hrs",
    "safetyRating": 3,
    "toxicityLD50": "~50 mg/kg (nicotine)",
    "legalStatus": "Legal / Unregulated",
    "region": "Australia",
    "tags": ["⚠️ Caution", "🍃 Leaf"],
    "affiliateLink": null,
    "description": "Desert shrub traditionally chewed for stimulating and focusing effects.",
    "id": "duboisia-hopwoodii",
    "therapeuticUses": "Endurance aid, traditional medicine",
    "sideEffects": "Nausea, dizziness, increased heart rate",
    "contraindications": "Heart problems, pregnancy",
    "drugInteractions": "Nicotine replacement therapies, antihypertensives",
    "toxicity": "Moderate due to nicotine",
    "pharmacokinetics": "Buccal absorption; hepatic metabolism"
  },
  {
    "name": "Synaptolepis kirkii",
    "scientificName": "Synaptolepis kirkii",
    "category": "Oneirogen",
    "effects": ["vivid dreams", "trance"],
    "mechanismOfAction": "Alkaloids may modulate cholinergic pathways and NMDA receptors",
    "activeConstituents": [
      {
        "name": "kirkinine",
        "type": "alkaloid",
    ...
    "preparation": "Root tincture or cold water soak",
    "dosage": "0.5-1 g root",
    "onset": "30 min",
    "duration": "6-8 hrs",
    "safetyRating": 2,
    ...
    "tags": ["💤 Dream", "🌿 Root"],
    "affiliateLink": null,
    "description": "Known as \\"uvuma-omhlope\\", used by Zulu diviners to induce prophetic dreams.",
    "id": "synaptolepis-kirkii",
    "therapeuticUses": "Dream induction, spiritual rituals",
    "sideEffects": "Mild nausea in some users",
    "contraindications": "Pregnancy, epilepsy",
    "drugInteractions": "None documented",
    "toxicity": "Low",
    "pharmacokinetics": "Likely active constituents absorbed orally"
  },
  {
    "name": "Mitragyna javanica",
    "scientificName": "Mitragyna javanica",
    "category": "Stimulant / Relaxant",
    "effects": ["mild euphoria", "relaxation"],
    "mechanismOfAction": "Mitragynine-like alkaloids act on opioid receptors",
    "activeConstituents": [
      {
        "name": "mitrajavine",
        "type": "alkaloid",
        "effect": "opioid agonist"
      }
    ],
    "preparation": "Leaves chewed or brewed as tea",
    "dosage": "1-3 g leaf",
    ...
    "tags": ["🍃 Leaf"],
    "affiliateLink": null,
    "description": "A milder relative of kratom sometimes used as a legal alternative.",
    "id": "mitragyna-javanica",
    "therapeuticUses": "Mild stimulation, relaxation",
    "sideEffects": "Dry mouth, slight headache",
    "contraindications": "Liver impairment",
    "drugInteractions": "Other opioids or depressants",
    "toxicity": "Low",
    "pharmacokinetics": "Similar to kratom alkaloids"
  },
  {
    "name": "Desmodium gangeticum",
    "scientificName": "Desmodium gangeticum",
    "category": "Ayurvedic / Adaptogen",
    "effects": ["calming", "anti-inflammatory"],
    "mechanismOfAction": "Isoflavones interact with GABAergic and anti-inflammatory pathways",
    "activeConstituents": [
      {
        "name": "desmodin",
        "type": "alkaloid",
    ...
    "duration": "4-6 hrs",
    "safetyRating": 1,
    "toxicityLD50": ">2 g/kg (rats)",
    "legalStatus": "Legal",
    "region": "India",
    "tags": ["🌿 Root"],
    "affiliateLink": "https://www.amazon.com/s?k=desmodium+gangeticum",
    "description": "Known as Salparni in Ayurveda, valued for its calming and rejuvenating properties.",
    "id": "desmodium-gangeticum",
    "therapeuticUses": "Anti-inflammatory, adaptogenic tonic",
    "sideEffects": "Rare stomach upset",
    "contraindications": "None known",
    "drugInteractions": "May potentiate sedatives",
    "toxicity": "Low",
    "pharmacokinetics": "Taken orally; metabolites largely unknown"
  },
  {
    "name": "Thunbergia laurifolia",
    "scientificName": "Thunbergia laurifolia",
    "category": "Detox / Traditional",
    "effects": ["cleansing", "mild sedation"],
    "mechanismOfAction": "Antioxidant polyphenols and rosmarinic acid reduce oxidative stress",
    "activeConstituents": [
      {
    ...
    "preparation": "Leaves brewed as tea",
    "dosage": "1-2 g dried leaf",
    "onset": "10-20 min",
    "duration": "2-3 hrs",
    "safetyRating": 1,
    ...
    "region": "Thailand",
    "tags": ["🍃 Leaf", "🍵 Tea"],
    "affiliateLink": "https://www.etsy.com/market/thunbergia_laurifolia",
    "description": "Thai herb used in detox drinks and as a gentle relaxant.",
    "id": "thunbergia-laurifolia",
    "therapeuticUses": "Liver support, detoxification",
    "sideEffects": "Rare allergic reaction",
    "contraindications": "None known",
    "drugInteractions": "May interfere with medications metabolized by liver",
    "toxicity": "Low",
    "pharmacokinetics": "Consumed as tea; polyphenols metabolized hepatically"
  },
  {
    "name": "Nymphaea alba",
    "scientificName": "Nymphaea alba",
    "category": "Ritual / Visionary",
    "effects": ["relaxation", "dreaminess"],
    "mechanismOfAction": "Aporphine alkaloids act as dopamine agonists with sedative properties",
    "activeConstituents": [
      {
        "name": "aporphine",
        "type": "alkaloid",
    ...
    "preparation": "Petals or rhizomes steeped in wine or tea",
    "dosage": "3-5 g dried petals",
    "onset": "20-40 min",
    "duration": "3-5 hrs",
    "safetyRating": 1,
    "toxicityLD50": "Not established",
    ...
    "region": "Europe",
    "tags": ["🌸 Flower"],
    "affiliateLink": "https://www.amazon.com/s?k=nymphaea+alba",
    "description": "European white water lily traditionally associated with calm and mild dream states.",
    "id": "nymphaea-alba",
    "therapeuticUses": "Anxiety relief, sleep aid",
    "sideEffects": "Drowsiness at higher doses",
    "contraindications": "Pregnancy",
    "drugInteractions": "Sedatives, dopamine agents",
    "toxicity": "Low",
    "pharmacokinetics": "Absorbed orally; duration several hours"
  },
  {
    ...
    "mechanismOfAction": "Hirsutine and related alkaloids interact weakly with opioid receptors",
    "activeConstituents": [
      {
        "name": "hirsutine",
        "type": "alkaloid",
    ...
    "preparation": "Leaves brewed as tea or chewed",
    "dosage": "2-4 g leaf",
    "onset": "20-40 min",
    "duration": "2-4 hrs",
    "safetyRating": 2,
    ...
    "tags": ["🍃 Leaf"],
    "affiliateLink": null,
    "description": "Another kratom relative used locally for gentle stimulant effects.",
    "id": "mitragyna-hirsuta",
    "therapeuticUses": "Fatigue reduction",
    "sideEffects": "Mild headache",
    "contraindications": "Avoid with opioids",
    "drugInteractions": "Other CNS depressants",
    "toxicity": "Low",
    "pharmacokinetics": "Similar to other Mitragyna species"
  },
  {
    "name": "Lobelia inflata",
    "scientificName": "Lobelia inflata",
    "category": "Respiratory / Nootropic",
    "effects": ["stimulating", "bronchodilation"],
    "mechanismOfAction": "Lobeline acts as a nicotinic receptor agonist and dopamine releaser",
    "activeConstituents": [
      {
        "name": "lobeline",
        "type": "alkaloid",
    ...
    "preparation": "Dry herb smoked or made into tincture",
    "dosage": "50-100 mg dried herb",
    "onset": "5-10 min",
    "duration": "1-2 hrs",
    "safetyRating": 3,
    "toxicityLD50": "~50 mg/kg (mice)",
    "legalStatus": "Legal",
    "region": "North America",
    "tags": ["🌿 Leaf", "⚠️ Caution"],
    "affiliateLink": "https://www.amazon.com/s?k=lobelia+inflata",
    "description": "Also called Indian tobacco, historically used for respiratory ailments and as a tobacco substitute.",
    "id": "lobelia-inflata",
    "therapeuticUses": "Expectorant, smoking cessation aid",
    "sideEffects": "Nausea, sweating in excess",
    "contraindications": "Heart disease, pregnancy",
    "drugInteractions": "Nicotine products, antihypertensives",
    "toxicity": "Moderate",
    "pharmacokinetics": "Rapid absorption when smoked or taken orally"
  },
  {
    "name": "Picralima nitida",
    "scientificName": "Picralima nitida",
    "category": "Analgesic / Traditional",
    "effects": ["pain relief", "sedation"],
    "mechanismOfAction": "Akuammine alkaloids act on opioid receptors",
    "activeConstituents": [
      {
        "name": "akuammine",
        "type": "alkaloid",
    ...
    "preparation": "Seeds ground and swallowed",
    "dosage": "250-500 mg seed powder",
    "onset": "30-60 min",
    "duration": "3-5 hrs",
    "safetyRating": 2,
    "toxicityLD50": "Not established",
    ...
    "region": "West Africa",
    "tags": ["🌰 Seed"],
    "affiliateLink": "https://www.etsy.com/market/akuamma_seeds",
    "description": "Seeds of the African akuamma tree used as a folk painkiller comparable to low-dose opioids.",
    "id": "picralima-nitida",
    "therapeuticUses": "Analgesic, antimalarial folk uses",
    "sideEffects": "Drowsiness, mild nausea",
    "contraindications": "Concurrent opioid therapy",
    "drugInteractions": "Opioid medications, CNS depressants",
    "toxicity": "Low to moderate",
    "pharmacokinetics": "Alkaloids metabolized hepatically"
  },
  {
    "name": "Calotropis procera",
    "scientificName": "Calotropis procera",
    "category": "Ethnobotanical / Rare",
    "effects": ["analgesic", "sedation"],
    "mechanismOfAction": "Cardenolides and other compounds interfere with calcium transport and nervous conduction",
    "activeConstituents": [
      {
        "name": "calotropin",
        "type": "cardenolide",
        "effect": "cardiac active"
      }
    ],
    "preparation": "Latex or root bark used cautiously",
    "dosage": "<0.5 g dried root",
    "onset": "15-30 min",
    "duration": "2-4 hrs",
    "safetyRating": 4,
    "toxicityLD50": "~200 mg/kg (rats)",
    "legalStatus": "Unregulated",
    "region": "Africa, Middle East",
    "tags": ["☠️ Toxic", "🌿 Root"],
    "affiliateLink": null,
    "description": "Also called Sodom apple; latex and root are potent and potentially toxic but used in folk medicine for pain.",
    "id": "calotropis-procera",
    "therapeuticUses": "Topical analgesic, traditional rituals",
    "sideEffects": "Vomiting, arrhythmia",
    "contraindications": "Heart conditions, pregnancy",
    "drugInteractions": "Cardiac glycosides",
    "toxicity": "High",
    "pharmacokinetics": "Compounds rapidly absorbed; narrow therapeutic index"
  }
]
`;let e=[];try{const n=i.replace(/NaN/g,"null");e=JSON.parse(n)}catch(n){console.error("Failed to load herb data",n),e=[]}const t=e,a=[{name:"DMT",type:"tryptamine",mechanism:"5-HT2A agonist",aliases:["N,N-Dimethyltryptamine"],tags:["psychedelic"],duration:"15-60 min",originHerbs:["mimosa-hostilis"],biosynthesisNotes:"Derived from tryptophan via tryptamine"},{name:"mescaline",type:"phenethylamine",mechanism:"5-HT2A agonist",aliases:["3,4,5-trimethoxyphenethylamine"],tags:["psychedelic"],duration:"8-12 h",originHerbs:["lophophora-williamsii"]},{name:"caffeine",type:"xanthine",mechanism:"Adenosine receptor antagonist",tags:["stimulant"],duration:"3-5 h",originHerbs:["camellia-sinensis"]},{name:"mitragynine",type:"indole alkaloid",mechanism:"Partial μ-opioid agonist",tags:["opioid","stimulant"],originHerbs:["mitragyna-speciosa"]},{name:"cocaine",type:"alkaloid",mechanism:"Blocks monoamine reuptake",tags:["stimulant"],toxicity:"Highly addictive and cardiotoxic"},{name:"scopolamine",type:"alkaloid",mechanism:"Muscarinic acetylcholine antagonist",tags:["deliriant"]},{name:"digitoxin",type:"glycoside",mechanism:"Inhibits Na+/K+-ATPase",tags:["cardiac"]},{name:"chamazulene",type:"terpene",mechanism:"Anti-inflammatory",sourceHerbs:["achillea-millefolium"],tags:["anti-inflammatory"]},{name:"thujone",type:"monoterpene",mechanism:"GABA_A antagonist",sourceHerbs:["achillea-millefolium","salvia-apiana"],tags:["gaba"]},{name:"vertine",type:"alkaloid",mechanism:"Unclear CNS action",sourceHerbs:["heimia-myrtifolia"],tags:["sedative"]},{name:"7-hydroxymitragynine",type:"indole alkaloid",mechanism:"Potent μ-opioid agonist",sourceHerbs:["kratom-hybrids"],tags:["opioid"]},{name:"cineole",type:"terpene",mechanism:"Aromatic stimulant",sourceHerbs:["salvia-apiana"],tags:["stimulant"]},{name:"tenuigenin",type:"glycoside",mechanism:"Neurotrophic modulation",sourceHerbs:["polygala-tenuifolia"],tags:["nootropic"]},{name:"nicotine",type:"alkaloid",mechanism:"Nicotinic acetylcholine agonist",sourceHerbs:["nicotiana-tabacum"],tags:["stimulant"]},{name:"ephedrine",type:"alkaloid",mechanism:"Adrenergic agonist",sourceHerbs:["sida-acuta"],tags:["stimulant"]},{name:"marmelosin",type:"coumarin",mechanism:"Mild sedative",sourceHerbs:["aegle-marmelos"],tags:["sedative"]},{name:"anthocyanins",type:"flavonoid",mechanism:"Antioxidant & hypotensive",sourceHerbs:["hibiscus-sabdariffa"],tags:["antioxidant"]},{name:"verbenalin",type:"glycoside",mechanism:"GABAergic modulation",sourceHerbs:["verbena-officinalis"],tags:["sedative"]},{name:"pinocamphone",type:"monoterpene",mechanism:"Convulsant in high doses",sourceHerbs:["hyssopus-officinalis"],tags:["convulsant"]},{name:"marrubiin",type:"diterpenoid",mechanism:"Expectorant effects",sourceHerbs:["marrubium-vulgare"],tags:["expectorant"]},{name:"thymol",type:"phenolic",mechanism:"Antimicrobial",sourceHerbs:["thymus-vulgaris"],tags:["antimicrobial"]},{name:"linalool",type:"terpene",mechanism:"Sedative via GABA",sourceHerbs:["lavandula-angustifolia"],tags:["sedative"]},{name:"echinacoside",type:"phenolic",mechanism:"Immunomodulator",sourceHerbs:["echinacea-purpurea"],tags:["immunomodulator"]},{name:"valeranon",type:"sesquiterpene",mechanism:"Sedative",sourceHerbs:["valeriana-jatamansi"],tags:["sedative"]},{name:"catuabine",type:"alkaloid",mechanism:"Dopamine modulation",sourceHerbs:["erythroxylum-catuaba"],tags:["aphrodisiac"]},{name:"apomorphine",type:"alkaloid",mechanism:"Dopamine agonist",sourceHerbs:["nymphaea-rubra"],tags:["dopamine"]},{name:"gymnemic acids",type:"triterpenoid",mechanism:"Block sweet receptors",sourceHerbs:["gymnema-sylvestre"],tags:["sweet-blocker"]}],s=a;export{t as a,s as b,e as h};
