...
|---|---|---|---|---|
| Discovery / SEO | #5629 | Razzleberrytt / swarm | Admitted / ready for implementation | Resolve Kava article vs herb-guide reader-job overlap without broad-rewriting or redirecting the 585-citation article absent preservation proof. |

- **Discovery/SEO:** occupied by #5629; no overlapping Discovery admission until it merges or closes.
