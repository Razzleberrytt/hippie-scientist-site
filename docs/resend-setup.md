# Resend / Form Endpoint Status

## MVP status

Lead-capture/newsletter form infrastructure from legacy SPA flows is **deferred from active MVP scope** unless explicitly reintroduced in active App Router routes.
