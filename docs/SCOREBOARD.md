...
| Publication parity failures | Profiles whose final robots, sitemap membership, and manifest status disagree | Unknown exact count; phase totals disagree | Build artifacts | 2026-08-21 | Data/SEO engineer | Execute SEO-001 | This is a new operating metric |
