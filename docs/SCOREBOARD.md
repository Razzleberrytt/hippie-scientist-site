...
| Publication parity failures | Profiles whose final robots, sitemap membership, and manifest status disagree | 0 across 846 built profiles; 285 sitemap-eligible and 285 included | `reports/profile-publication-truth.json`; Production Content Invariants run #1746; PR #4262 | 2026-08-25 clean build | Data/SEO engineer | Monitor the retained CI artifact for count or reason drift | This proves final build parity, not Google index coverage |
