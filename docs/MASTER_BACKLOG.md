...
|---|---|---|---|---|---|---:|---|---|---|---|---|
| #4232 | Repair normalized enrichment provenance and cross-entity Ashwagandha safety source | O | In Review | P0 safety/provenance incident | 4/5/3/5/1/1 | 300.0 | First governed cheap scan after #4223; no overlapping active lease/PR on intended data files | Restore six already-cited normalized source identities; replace Ashwagandha pregnancy's CBD/EPIDIOLEX source with an exact Ashwagandha-specific authority; preserve valid CBD links; keep evidence classes conservative; remove no null/safety evidence | Issue #4232; PR #4233; source-registry and normalized-entry validators; governor tests/benchmark/canaries; required CI/build/release gates; independent review; post-merge verification | `public/data/source-registry.json`, `public/data/enrichment-normalized.jsonl`, governor canary regression, governance queue records | First governor scan found a material cross-entity safety provenance defect plus an empty registry; do not bypass validation to repair it |
