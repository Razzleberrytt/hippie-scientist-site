...
- **A — #4266 / PR_PENDING in review:** governed KSM-66 Ashwagandha safety review is the active Authority/Content workstream under lease `lease-4266-ashwagandha-safety-rct`; scope is one source identity, three calibrated normalized records, regenerated rollup, and exact regression coverage.
...
|---|---|---|---|---|---|---:|---|---|
| #4266 | Evaluate 2026 KSM-66 Ashwagandha safety RCT | A evidence | **In review — PR_PENDING** | P1 evidence | 4/5/3/5/.75/3 | 75.0 | Governed lease acquired and merged; exact-head source/normalized/governed/regression checks must pass before merge | Preserve formulation, dose, duration, population, null findings, limitations, funding/product-supply context; no broad safety or efficacy generalization |
