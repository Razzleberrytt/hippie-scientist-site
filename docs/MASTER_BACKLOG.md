...
Current review state: **1/3 normal implementation workstreams occupied**. #5703 / PR #5961 is merged and retired; Authority/Content is now owned by #5706 for the bounded CoQ10 endpoint-discordance and canonical-identity closure. #5963 is its exact-main state-only governor-lease prerequisite and does not consume a normal implementation workstream. #5707 and #5708 remain staging-only; #5081 remains separately blocked on its own lease. Prior refill-cycle items remain merged and retired.

| Ticket | Title | Lane | Status | Priority | BI/UV/TP/SL/C/E | Score | Freshness |
|---|---|---|---|---|---|---:|---|
| #5706 | Reconcile CoQ10 depression/anxiety endpoint discordance and canonical identity | A | Admitted — blocked on #5963 lease | P1 evidence governance | — | — | Existing Session C CoQ10 integrity findings + PMID 40833470; canonical owner `compound:coenzyme-q10` |
