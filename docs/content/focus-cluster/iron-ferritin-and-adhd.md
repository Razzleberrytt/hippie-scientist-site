...
# Iron/Ferritin and ADHD: What the Research Shows About Dopamine, Deficiency, Attention, Hyperactivity, Sleep, and Supplementation

Iron is an essential mineral that serves as a critical cofactor in numerous biological processes, including oxygen transport, energy metabolism, and neurotransmitter synthesis. Among its most important roles in the brain is its function as a cofactor for tyrosine hydroxylase, the rate-limiting enzyme in dopamine production. Ferritin, the primary intracellular storage protein for iron, serves as a key biomarker of body iron stores. Low ferritin levels, even in the absence of anemia, have been associated in multiple observational studies and meta-analyses with greater ADHD symptom severity, poorer sleep quality, and restless legs syndrome (RLS)—a condition that itself disrupts sleep and can exacerbate daytime inattention and hyperactivity.
...
|---|---|---|---|---|
| Ferritin levels (observational) | Children with ADHD | Significantly lower serum ferritin vs controls (Hedges’ g ≈ −0.25 in meta-analysis); 50–84% <30 ng/mL in some cohorts vs much lower in controls | Moderate (multiple metas, consistent direction) | Association robust; screen when symptoms or diet suggest risk |
| Iron deficiency & symptom severity | Pediatric ADHD | Greater hyperactivity, inattention, or overall severity with low ferritin/ID | Moderate | Low ferritin can amplify symptom expression; correction may help |
| Supplementation in low ferritin | Non-anemic ADHD children (RCTs) | Significant ADHD-RS improvement with ferrous sulfate 80 mg/day ×12 weeks (Konofal 2008); trends on Conners’; CGI improved | Low–Moderate (small n, but replicated signals) | Modest supportive benefit clearest in deficient non-anemic subgroup |
| RLS / sleep | ADHD + RLS or low ferritin | High RLS comorbidity; low ferritin worsens RLS/PLMS and fragments sleep; repletion improves sleep continuity | Moderate (strong RLS literature + ADHD overlap) | High-yield target for sleep-focused intervention in ADHD |
| Dopamine mechanism | Preclinical + human correlational | Iron required for TH activity; deficiency reduces dopamine synthesis, alters DAT/D2; correlates with ADHD severity | Moderate (mechanistic clarity, human association) | Core biological rationale; supports testing in symptomatic patients |
| Adult data | Adults with ADHD/RLS | Lower ferritin in some cohorts; strong RLS overlap; limited supplementation RCTs | Low | Extrapolate from pediatric + RLS evidence; test especially with sleep complaints |
| Overall evidence grade | Mixed pediatric (limited adult) | Consistent association with low ferritin; supportive but limited supplementation data in deficient subgroups | Low–Moderate | Targeted nutritional support when deficient; not routine or universal ADHD treatment |

## Iron Forms Comparison Table

| Form | Pros | Cons | Best Fit |
|---|---|---|---|
| Ferrous Sulfate | Inexpensive; effective; studied in key ADHD RCT | High GI side effects (constipation, nausea); dark stools | Cost-sensitive cases where tolerated; short-term therapeutic use |
| Ferrous Bisglycinate | Excellent GI tolerability; good absorption; fewer interactions with inhibitors | Higher cost per elemental mg; lower elemental % per tablet | Children, sensitive stomachs, long-term or maintenance; preferred for most ADHD patients |
| Ferrous Fumarate | Good elemental content; generally well tolerated | GI effects possible (less than sulfate) | Alternative when sulfate problematic |
| Ferrous Gluconate | Lower elemental content; often gentler on stomach | May require more tablets for therapeutic dose | Sensitive individuals or maintenance dosing |
| Heme Iron (or heme polypeptide) | Highest bioavailability; minimal GI upset; less dietary inhibition | More expensive; animal-derived (vegan options limited) | Vegetarians/vegans, GI-intolerant patients, or those preferring food-based forms |
...
| --------------------------------------------------- | ----------------------------------------------------------------------- |
| Nutrient                                            | Iron                                                                    |
| Primary Biomarker                                   | Ferritin                                                                |
| Primary Mechanism                                   | Dopamine synthesis via tyrosine hydroxylase                             |
| Evidence Type                                       | Observational studies, meta-analyses, randomized supplementation trials |
| Strongest ADHD Association                          | Low ferritin and increased symptom severity                             |
| Strongest Clinical Use Case                         | ADHD with low ferritin, poor sleep, or restless legs syndrome           |
| Typical Ferritin Target Discussed in RLS Literature | >50 ng/mL                                                               |
| Evidence Grade                                      | B (supportive but not definitive)                                       |
| Typical Time to Evaluate Response                   | 8–12 weeks                                                              |
| Major Safety Concern                                | Iron overload in non-deficient individuals                              |

## Study Registry

| Study                | Type                        | Population                                           | Key Findings                                                                          |
| -------------------- | --------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Konofal et al., 2004 | Observational               | Children with ADHD                                   | Low ferritin strongly associated with ADHD symptom severity.                          |
| Konofal et al., 2008 | Randomized Controlled Trial | Non-anemic children with ADHD and ferritin <30 ng/mL | Iron supplementation significantly improved ADHD Rating Scale scores and CGI ratings. |
| Tseng et al., 2018   | Meta-analysis               | 1,560 ADHD cases, 4,691 controls                     | Ferritin significantly lower in ADHD populations.                                     |
| Wang et al.          | Meta-analysis               | Pediatric ADHD cohorts                               | Iron deficiency associated with increased ADHD prevalence and severity.               |
| Cortese et al.       | Systematic Review           | ADHD and sleep disorders                             | Identified strong overlap between ADHD, RLS, and low ferritin.                        |
| Dosman et al.        | Observational               | Children with ADHD                                   | Lower ferritin associated with more severe behavioral symptoms.                       |
| Juneja et al.        | Case-Control                | Pediatric ADHD                                       | Lower iron stores correlated with increased symptom burden.                           |
| Oner et al.          | Observational               | Children with ADHD                                   | Ferritin inversely associated with ADHD symptom severity.                             |
| Youssef et al.       | Clinical Study              | ADHD children                                        | Iron deficiency associated with worse executive and behavioral outcomes.              |
| Allen et al.         | RLS Guideline Evidence      | Adults and children with RLS                         | Ferritin >50 ng/mL associated with improved symptom management.                       |

## Primary Sources

1. Konofal E, Lecendreux M, Arnulf I, Mouren MC. Iron deficiency in children with attention-deficit/hyperactivity disorder. Arch Pediatr Adolesc Med. 2004.

2. Konofal E, Cortese S, Marchand M, Mouren MC, Arnulf I, Lecendreux M. Impact of iron supplementation on attention deficit hyperactivity disorder in children. Pediatr Neurol. 2008.

3. Tseng PT, Cheng YS, Yen CF, et al. Peripheral iron levels in children with attention-deficit hyperactivity disorder: a systematic review and meta-analysis. Sci Rep. 2018.

4. Wang Y, Huang L, Zhang L, Qu Y, Mu D. Iron status in attention-deficit/hyperactivity disorder: a systematic review and meta-analysis.

5. Cortese S, Angriman M, Lecendreux M, Konofal E. Iron and attention deficit/hyperactivity disorder: what is the empirical evidence so far? Sleep Med.

6. Dosman CF, Drmic IE, Brian JA, et al. Ferritin as an indicator of suspected iron deficiency in children with ADHD.

7. Oner P, Oner O, Azik FM, Cop E, Munir KM. Ferritin and ADHD symptom severity.

8. Juneja M, Jain R, Singh V, Mallika V. Iron deficiency in Indian children with ADHD.

9. Youssef J, Waddington F, et al. Iron deficiency and neurobehavioral outcomes.

10. Allen RP, Picchietti DL, Garcia-Borreguero D, et al. Restless Legs Syndrome diagnostic and treatment recommendations.

11. Earley CJ, Connor JR, Beard JL, et al. Insights into brain iron deficiency in restless legs syndrome.

12. Beard JL. Why iron deficiency is important in infant development.

13. Lozoff B, Georgieff MK. Iron deficiency and brain development.

14. Connor JR, Wang XS, Allen RP, et al. Altered dopaminergic profile in iron deficiency.

15. Rao R, Georgieff MK. Iron in fetal and neonatal nutrition.

16. World Health Organization. Iron deficiency anaemia: assessment, prevention and control.

17. National Institutes of Health Office of Dietary Supplements. Iron Fact Sheet for Health Professionals.

18. American Academy of Sleep Medicine guidance on ferritin and RLS.

19. European Restless Legs Syndrome Study Group recommendations.

20. Current reviews on non-anemic iron deficiency and neurocognitive function.
