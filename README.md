...
- Email capture for ADHD guides uses the Cloudflare Pages Function at `/api/subscribe`; configure `MAILCHIMP_API_KEY`, `MAILCHIMP_API_SERVER`, `MAILCHIMP_LIST_ID`, and `MAILCHIMP_ADHD_TAG` as Cloudflare Pages environment variables.
