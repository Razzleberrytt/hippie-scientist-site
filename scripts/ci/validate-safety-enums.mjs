...
const VALID = new Set(['Generally well tolerated', 'Use caution', 'Interaction risk', 'Safety review pending', 'Limited safety data', 'Safety data limited', 'Interaction review pending', 'See profile cautions'])
const out = []
let bad = 0
