...
const isNonIndexableRoute=(route)=>route.startsWith('/_not-found')||route.startsWith('/opengraph-image')||route.startsWith('/twitter-image')||route.startsWith('/robots.txt')||route.startsWith('/sitemap.xml')
const rows=[]
