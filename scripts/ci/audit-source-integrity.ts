/** Research/source integrity report projected from the canonical research-quality analysis. */
...
function buildCitationGraph(profiles: ResearchProfileEntry[]): Map<string, Set<string>> {
