...
results.unshift({
  ...
  stdoutTail: [
    ...
    `endpointCherryPick=${directionalConsistency.summary.endpointCherryPickRisks}`,
...
console.log(`Directionality: ${directionalConsistency.summary.findings} finding(s) · ${directionalConsistency.summary.highConfidenceFindings} high-confidence · endpoint cherry-pick ${directionalConsistency.summary.endpointCherryPickRisks} · heterogeneous bundles ${directionalConsistency.summary.directionalHeterogeneityClaims} · uniformly-positive overstatement ${directionalConsistency.summary.uniformlyPositiveOverstatements}`)
