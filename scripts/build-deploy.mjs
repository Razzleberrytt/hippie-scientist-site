...
const steps = [
  ...
  },
  {
    ...
    inputs: [
      ...
      'styles/**/*',
      'public/data/**/*',
      'public/images/*.{jpg,jpeg,png,gif,avif,tif,tiff,webp}',
      'public/images/guides/**/*.{jpg,jpeg,png,gif,avif,tif,tiff,webp}',
      'public/images/learn/**/*.{jpg,jpeg,png,gif,avif,tif,tiff,webp}',
      'public/images/monographs/**/*.{jpg,jpeg,png,gif,avif,tif,tiff,webp}',
      'data/**/*.{ts,json}',
      'scripts/build-production.mjs',
      'scripts/optimize-images.mjs',
      'scripts/ci/validate-responsive-monograph-images.mjs',
      'next.config.*',
      'postcss.config.*',
      'tailwind.config.*',
      'package.json',
