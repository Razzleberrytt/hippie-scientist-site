...
describe('distribution factual-copy unbound context lint', () => {
  it.each([
    ...
    'Needs 2 hours to take effect',
    'Requires 1 day to act',
    ...
    'Worse than placebo',
    'Greater efficacy than melatonin',
    'Superior efficacy to melatonin',
    'Human study',
  ...
  it.each([
    ...
    'Better evidence starts with context',
    'A greater evidence library',
    'Read the evidence',
