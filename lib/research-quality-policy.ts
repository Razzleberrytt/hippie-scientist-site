...
const DIMENSION_BY_KIND: Record<string, ResearchGapDimension> = {
  ...
  'evidence-independence-metadata-gap': 'identity',
  'poor-study-metadata-coverage': 'metadata',
  'research-metadata-integrity': 'metadata',
...
function addTopologyReasons(topology: ResearchQualityTopology, add: AddReason) {
  ...
  const aggregatedWeights = {
    ...
    metadataIntegrity: RESEARCH_GAP_WEIGHTS.metadataIntegrity,
    highConfidenceMetadataIntegrityBonus: RESEARCH_GAP_WEIGHTS.highConfidenceMetadataIntegrityBonus,
    ...
    underlyingStudyPublicationReuse: RESEARCH_GAP_WEIGHTS.underlyingStudyPublicationReuse,
    highConfidenceUnderlyingStudyPublicationReuseBonus: RESEARCH_GAP_WEIGHTS.highConfidenceUnderlyingStudyPublicationReuseBonus,
    independenceMetadataGap: RESEARCH_GAP_WEIGHTS.independenceMetadataGap,
