...
export const focusAdhdArticles: FocusAdhdArticle[] = [
  {
    ...
    seoTitle: 'Best Supplements for ADHD: Evidence and Safety',
  ...
  },
  {
    ...
    seoTitle: 'Omega-3 and ADHD: EPA, DHA, Dose and Safety',
  ...
  },
  {
    ...
    description: 'Citicoline vs Alpha-GPC for ADHD — evidence review, dosing guide, and side effects comparison. Covers clinical studies on ADHD attention, impulse control, and how these choline sources compare.',
    category: 'Supplement Evidence',
    tags: ['Focus', 'ADHD', 'Supplement Evidence'],
    date: '2026-06-10',
    readingTime: '13 min read',
