...
export function buildPracticalDifferences(left: any, right: any) {
  return {
...
export function buildOnsetComparison(left: any, right: any) {
  return {
...
export function buildEvidenceComparison(left: any, right: any) {
...
export function buildStackCompatibilityDifferences(left: any, right: any) {
  return {
...
export function buildPreferenceGuidance(left: any, right: any) {
  return {
...
export function buildRealisticExpectationDifferences(left: any, right: any) {
  return {
