...
export function hasHumanEvidence(record: Record<string, unknown>): boolean {
...
export function hasMechanismEvidence(record: Record<string, unknown>): boolean {
...
export function isPreliminaryResearch(record: Record<string, unknown>): boolean {
  const evidence = evidenceText(record)
...
export function getEvidenceTier(record: Record<string, unknown>): EvidenceTier {
  const evidence = evidenceText(record)
...
export function getEvidenceLabel(record: Record<string, unknown>): string {
...
export function getEvidenceColor(record: Record<string, unknown>): EvidenceColor {
...
export function getEvidenceLetterGrade(record: Record<string, unknown>): EvidenceLetterGrade {
...
export function hasStrongSafetyProfile(record: Record<string, unknown>): boolean {
  const safety = [
    record?.safety,
    record?.safetyNotes,
    record?.safety_notes,
