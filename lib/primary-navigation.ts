...
export const primaryNavigation: PrimaryNavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { section: 'Health goals', label: 'Stress', href: '/guides/stress', description: 'Acute tension, chronic overload, burnout, sleep disruption, and cortisol concerns' },
      { section: 'Health goals', label: 'Anxiety', href: '/guides/anxiety', description: 'Overthinking, tension, calming supports, and anxiety-focused evidence' },
  ...
  },
  {
    label: 'Tools',
    href: '/safety-checker',
    description: 'Safety screening, evidence lookup, botanical comparisons, dosing, and shareable resources',
