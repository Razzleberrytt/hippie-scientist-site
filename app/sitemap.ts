...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const sitemapEntries: MetadataRoute.Sitemap = [
    ...
    route(normalizeSitemapUrl('/info/free-guide'), 'yearly', 0.5),
    route(normalizeSitemapUrl('/info/infographics'), 'monthly', 0.5),
    route(normalizeSitemapUrl('/info/newsletter'), 'monthly', 0.4),
    route(normalizeSitemapUrl('/evidence/evidence-digest'), 'weekly', 0.85),
    route(normalizeSitemapUrl('/evidence/evidence-checker'), 'monthly', 0.6),
    ...
    route(normalizeSitemapUrl('/library'), 'monthly', 0.85),
