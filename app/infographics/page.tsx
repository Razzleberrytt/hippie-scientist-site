...
const infoGraphicEmbedCode = (slug: string, width: number, height: number, alt: string) => 
  `<a href="https://thehippiescientist.net/evidence-report/">
  <img src="https://thehippiescientist.net/infographics/${slug}.png" 
       alt="${alt}" width="${width}" height="${height}" 
       style="max-width:100%;height:auto;border:0" />
</a>
<p style="font-size:12px;color:#666">Data from 
  <a href="https://thehippiescientist.net/evidence-report/">The Hippie Scientist Evidence Report</a>
</p>`
...
{infoGraphicEmbedCode('adhd-supplements-evidence', 600, 800, 'ADHD Supplements Evidence Levels — The Hippie Scientist')}
      ...
      <section className="max-w-4xl card-premium p-6 space-y-4">
        ...
        <div className="pt-2">
          <Link href="/evidence-report/" className="text-sm font-bold text-brand-700 transition hover:text-brand-800">
