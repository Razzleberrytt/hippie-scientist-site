...
import { buildPageMetadata, CANONICALIZED_AWAY_PROFILE_SLUGS, faqPageJsonLd, generateDetailMetadata, isMeaningfulFaqAnswer, SITE_URL } from '../../../lib/seo'
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl lg:max-w-6xl space-y-10 px-4 py-6 pb-20">
        ...
        <div id="compounds"><CompoundSourceHerbs compoundSlug={compound.slug} compoundName={displayName} compound={compound as RuntimeRecord} /></div>
