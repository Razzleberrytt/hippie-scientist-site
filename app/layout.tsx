          ...
          <footer className='mt-8 border-t border-neutral-200 bg-neutral-50 sm:mt-12'>
            <div className='container-page py-8 sm:py-12'>
              <div className='grid gap-7 md:grid-cols-3'>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='flex flex-col gap-2 text-sm'>
                    ...
                    <Link href='/affiliate-disclosure' className='text-muted hover:text-ink transition'>Affiliate Disclosure</Link>
              ...
              >
                ...
                <p className='text-sm text-muted'>&copy; 2024-{new Date().getFullYear()} The Hippie Scientist</p>
              </section>
            </div>
          </footer>
          <MobileBottomNav />
