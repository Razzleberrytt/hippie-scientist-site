...
export const metadata: Metadata = {
  ...
  description:
    'Evidence-ranked anxiety herbs with 19 clinical sources: oral Silexan lavender oil, ashwagandha, chamomile, passionflower and kava, including negative trials, funding context and safety limits.',
...
export default function BestHerbsForAnxietyPage() {
  ...
  return (
    <ArticleLayout toc={toc} zone="supplement">
      <StructuredData pageUrl={PAGE_URL} headline="Best Herbs for Anxiety: Evidence-Ranked Guide (2026)" description="Evidence-ranked comparison of oral Silexan lavender oil, ashwagandha, chamomile, passionflower and kava, with 19 clinical sources." datePublished="2026-06-16" dateModified={DATE} breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Guides', href: '/guides' }, { label: 'Anxiety', href: '/guides/anxiety/' }, { label: 'Best Herbs for Anxiety', href: '/guides/anxiety/best-herbs-for-anxiety' }]} />
      <JsonLd schema={faqSchema} />

      <div className="space-y-10">
        <section className="rounded-[2rem] border border-brand-900/10 bg-white/90 p-6 shadow-sm sm:p-10">
          <p className="eyebrow-label">Anxiety herb evidence guide · 19-source ledger</p>
        ...
        <section id="ranking" className="scroll-mt-20 space-y-4">
          ...
          <div className="overflow-x-auto rounded-[1.65rem] border border-brand-900/10 bg-white shadow-sm"><table className="min-w-[960px] w-full text-sm"><thead className="border-b border-brand-900/10 bg-brand-50/50"><tr><th className="p-4 text-left font-semibold text-ink">Option</th><th className="p-4 text-left font-semibold text-ink">Most direct evidence</th><th className="p-4 text-left font-semibold text-ink">Main limitation</th><th className="p-4 text-left font-semibold text-ink">Verdict</th></tr></thead><tbody className="divide-y divide-brand-900/10">
            ...
            <tr className="align-top"><td className="p-4 font-semibold text-ink">Kava</td><td className="p-4 text-muted">Older mixed trials, one positive 2013 GAD study and a negative larger 2020 GAD trial.<Cite n={10} /><Cite n={11} /><Cite n={12} /></td><td className="p-4 text-muted">Inconsistent efficacy plus rare severe liver injury reports.<Cite n={13} /><Cite n={14} /></td><td className="p-4 text-muted">Risk-benefit ceiling is high</td></tr>
          </tbody></table></div>
          <p className="text-sm leading-7 text-muted">A broader 2022 network meta-analysis of medicinal herbs concluded that the field remains preliminary because of small samples and strong placebo effects.<Cite n={19} /> A systematic review focused specifically on GAD likewise found most complementary approaches supported by limited evidence and poor safety reporting.<Cite n={15} /></p>
        </section>
