    ...
    <article className="mx-auto max-w-5xl px-4 pb-20 pt-6 sm:px-6 lg:px-8">
      ...
      <div className="space-y-8">
        ...
        <nav className="grid gap-3 sm:grid-cols-2">
          ...
          <Link href="/guides/other/magnesium-types-guide/" className="rounded-xl border border-brand-900/10 bg-white p-4 text-sm font-semibold text-brand-700 hover:border-brand-700/40">General Magnesium Types &amp; Absorption →</Link>
