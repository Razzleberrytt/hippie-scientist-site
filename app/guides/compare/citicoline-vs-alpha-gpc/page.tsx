...
const COMPARISON_LEFT = { label: 'Citicoline', candidates: ['citicoline', 'cdp-choline'] }
const COMPARISON_RIGHT = { label: 'Alpha-GPC', candidates: ['alpha-gpc', 'alpha-glycerophosphocholine'] }
