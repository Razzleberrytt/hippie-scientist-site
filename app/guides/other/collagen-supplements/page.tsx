...
export default function CollagenGuidePage() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section id="references" className="card-premium scroll-mt-24 p-6 space-y-4 max-w-4xl" aria-labelledby="collagen-references-heading">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <p className="eyebrow-label">Source ledger</p>
            <h2 id="collagen-references-heading" className="text-2xl font-semibold tracking-tight text-ink">References</h2>
          </div>
          <p className="text-xs font-semibold uppercase tracking-wide text-muted">12 sources</p>
        </div>
