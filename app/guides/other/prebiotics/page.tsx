...
export default function PrebioticsGuide() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section id="prebiotic-types" data-answer-engine-table="true" className="card-premium scroll-mt-24 p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">Prebiotic types compared</h2>
        <div className="overflow-x-auto"><table className="min-w-[720px] text-sm"><caption className="sr-only">Prebiotic types, best-supported uses, studied doses, and tolerability</caption><thead><tr className="border-b"><th scope="col" className="text-left py-3 pr-4">Type</th><th scope="col" className="text-left py-3 pr-4">Best evidence</th><th scope="col" className="text-left py-3 pr-4">Dose</th><th scope="col" className="text-left py-3">Tolerability</th></tr></thead><tbody className="text-muted">
          <tr className="border-b"><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">Inulin/FOS</th><td className="py-3 pr-4">Bifidobacterium ↑ [2]</td><td className="py-3 pr-4">5-10 g/day</td><td className="py-3">Moderate gas</td></tr>
          <tr className="border-b"><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">PHGG</th><td className="py-3 pr-4">IBS symptoms ↓ [5]</td><td className="py-3 pr-4">5-10 g/day</td><td className="py-3">Well tolerated</td></tr>
          <tr className="border-b"><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">GOS</th><td className="py-3 pr-4">Immune modulation [6]</td><td className="py-3 pr-4">2-5 g/day</td><td className="py-3">Well tolerated</td></tr>
          <tr><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">Resistant starch</th><td className="py-3 pr-4">Insulin sensitivity [7]</td><td className="py-3 pr-4">15-30 g/day</td><td className="py-3">Moderate gas</td></tr>
