...
export default function PrebioticsGuide() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section className="space-y-5 max-w-4xl"><p className="eyebrow-label">Evidence Review · 8 References</p><h1 className="text-5xl font-bold tracking-tight text-ink">Prebiotics: Feeding Your Gut Bacteria — Does It Matter?</h1><p className="text-lg leading-8 text-muted">The gut microbiome is one of the hottest areas in nutrition, and prebiotics — fibers that selectively feed beneficial bacteria — are central to the conversation. The 2017 ISAPP consensus formalized the definition [1]. But the gap between what prebiotics can do in controlled studies and what supplements promise on the label is substantial. Here&rsquo;s the evidence.</p></section>
