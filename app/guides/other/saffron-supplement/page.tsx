...
export default function SaffronPage() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section className="card-premium p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">How to choose a saffron supplement</h2><p className="text-sm leading-7 text-muted">Three factors matter. <strong>Standardization:</strong> look for extracts standardized to 2-3% safranal or crocin content. <strong>Stigma vs whole flower:</strong> the stigma contains 90%+ of bioactives. Whole-flower extracts are cheaper but less potent. <strong>Adulteration:</strong> saffron is frequently adulterated with safflower or dyed corn silk. Buy from brands that publish third-party identity testing. Standardized extract at 30 mg/day costs $15-30/month.</p></section>

      <section className="card-premium p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">Saffron vs other herbal antidepressants</h2><p className="text-sm leading-7 text-muted">Saffron has fewer drug interactions than St. John&apos;s Wort (which induces CYP3A4). More direct antidepressant evidence than ashwagandha (which primarily reduces cortisol). Less expensive than SAM-e with fewer GI side effects. The main limitation: all major trials come from Iran — independent Western replication is the most important gap in the evidence base.</p></section>
