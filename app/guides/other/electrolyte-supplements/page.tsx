...
export default function ElectrolyteGuidePage() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section id="electrolyte-products" data-answer-engine-table="true" className="card-premium scroll-mt-24 p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">Popular products compared</h2>
        <div className="overflow-x-auto"><table className="min-w-[880px] text-sm"><caption className="sr-only">Electrolyte products compared by sodium, potassium, sugar, and cost per serving</caption><thead><tr className="border-b"><th scope="col" className="text-left py-3 pr-4">Product</th><th scope="col" className="text-left py-3 pr-4">Na (mg)</th><th scope="col" className="text-left py-3 pr-4">K (mg)</th><th scope="col" className="text-left py-3 pr-4">Sugar (g)</th><th scope="col" className="text-left py-3">$/serving</th></tr></thead><tbody className="text-muted">
          <tr className="border-b"><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">LMNT</th><td className="py-3 pr-4">1,000</td><td className="py-3 pr-4">200</td><td className="py-3 pr-4">0</td><td className="py-3">$1.50</td></tr>
          <tr className="border-b"><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">Liquid IV</th><td className="py-3 pr-4">500</td><td className="py-3 pr-4">380</td><td className="py-3 pr-4">11</td><td className="py-3">$1.50</td></tr>
          <tr className="border-b"><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">DripDrop (NSF Sport)</th><td className="py-3 pr-4">330</td><td className="py-3 pr-4">185</td><td className="py-3 pr-4">9</td><td className="py-3">$1.25</td></tr>
          <tr><th scope="row" className="py-3 pr-4 text-left font-medium text-ink">DIY (salt + NoSalt)</th><td className="py-3 pr-4">575</td><td className="py-3 pr-4">350</td><td className="py-3 pr-4">0</td><td className="py-3">$0.05</td></tr>
