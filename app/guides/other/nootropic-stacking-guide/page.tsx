...
export default function NootropicStackingPage() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section className="card-premium p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">Week-by-week stacking plan</h2><p className="text-sm leading-7 text-muted">Week 1-2: Caffeine + L-theanine (foundation). Week 3: Add creatine. Week 5: Add bacopa or lion's mane — not both at once. Track effects at each stage. The best stack is the simplest one that reliably improves cognition without side effects.</p></section>
