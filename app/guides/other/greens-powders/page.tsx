...
export default function GreensPowdersPage() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section id="greens-powder-comparison" data-answer-engine-table="true" className="card-premium scroll-mt-24 p-6 space-y-4 max-w-4xl border-l-4 border-brand-700 bg-brand-50/30"><p className="text-xs font-bold uppercase tracking-wider text-brand-700">At a Glance · Greens Powder Reality Check</p>
        <div className="overflow-x-auto"><table className="min-w-full text-sm"><caption className="sr-only">Greens powder products compared by monthly cost, serving cost, ingredients, and third-party testing</caption><thead><tr className="border-b"><th scope="col" className="text-left py-2 pr-4 font-semibold text-ink">Product</th><th scope="col" className="text-left py-2 pr-4 font-semibold text-ink">Cost/mo</th><th scope="col" className="text-left py-2 pr-4 font-semibold text-ink">$/serving</th><th scope="col" className="text-left py-2 pr-4 font-semibold text-ink">Ingredients</th><th scope="col" className="text-left py-2 font-semibold text-ink">Third-Party Tested</th></tr></thead><tbody className="text-muted">
          <tr className="border-b"><th scope="row" className="py-2 pr-4 text-left font-medium text-ink">AG1</th><td className="py-2 pr-4">$79-99</td><td className="py-2 pr-4">$2.63-3.30</td><td className="py-2 pr-4">75+ (proprietary blends)</td><td className="py-2">NSF Sport</td></tr>
          <tr className="border-b"><th scope="row" className="py-2 pr-4 text-left font-medium text-ink">Live It Up</th><td className="py-2 pr-4">$40</td><td className="py-2 pr-4">$1.33</td><td className="py-2 pr-4">20+ (organic, no blends)</td><td className="py-2">Yes</td></tr>
          <tr className="border-b"><th scope="row" className="py-2 pr-4 text-left font-medium text-ink">Bloom</th><td className="py-2 pr-4">$35</td><td className="py-2 pr-4">$1.17</td><td className="py-2 pr-4">30+ (proprietary)</td><td className="py-2">Yes</td></tr>
          <tr><th scope="row" className="py-2 pr-4 text-left font-medium text-ink">Basic Multivitamin</th><td className="py-2 pr-4">$5-15</td><td className="py-2 pr-4">$0.17-0.50</td><td className="py-2 pr-4">Standard vitamins/minerals</td><td className="py-2">USP/NSF available</td></tr>
        </tbody></table></div>
