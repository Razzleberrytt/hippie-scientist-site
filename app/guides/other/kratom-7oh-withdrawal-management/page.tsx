  ...
  return (
    ...
    <div className="space-y-8">
      ...
      <div className="mt-8 flex gap-4 flex-wrap">
        ...
        <Link href="/articles/mitragynine" className="text-sm font-medium text-emerald-700 hover:underline">View mitragynine profile →</Link>
        <Link href="/compounds/kratom" className="text-sm font-medium text-emerald-700 hover:underline">View kratom profile →</Link>
        <Link href="/articles/7-hydroxymitragynine" className="text-sm font-medium text-emerald-700 hover:underline">View 7-OH compound profile →</Link>
      </div>
    </div>
    </ArticleLayout>
  )
