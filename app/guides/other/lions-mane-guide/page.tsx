...
export default function LionsManePage() {
  return (
    <div className="container-page py-10 space-y-10">
      ...
      <section className="card-premium p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">How it works</h2><p className="text-sm leading-7 text-muted">Lion&apos;s mane contains two families of bioactive compounds: <strong>hericenones</strong> (in the fruiting body) and <strong>erinacines</strong> (in the mycelium). Both cross the blood-brain barrier and stimulate nerve growth factor (NGF) synthesis in the hippocampus — the brain region critical for memory formation. NGF promotes neuronal survival, differentiation, and remyelination. This mechanism is distinct from every other nootropic: stimulants increase alertness via dopamine/norepinephrine, racetams modulate acetylcholine, adaptogens regulate the HPA axis. Lion&apos;s mane is the only supplement that directly stimulates brain repair and growth factors. The effect is cumulative, not acute — it builds over weeks of consistent use and may persist after stopping [1].</p></section>

      <section className="card-premium p-6 space-y-4 max-w-4xl"><h2 className="text-2xl font-semibold tracking-tight text-ink">The product quality problem</h2><p className="text-sm leading-7 text-muted">This is the single most important issue with lion&apos;s mane supplements. Most commercial products are <strong>myceliated grain</strong> — the mushroom is grown on a grain substrate (rice, oats), and the entire mass — mycelium + undigested grain — is dried and powdered. Independent testing shows these products contain 50-70% grain starch and only 5-10% actual mushroom beta-glucans. True fruiting body extracts (made from the mushroom cap alone) contain 30-40% beta-glucans — 3-8x more active compound. The price difference is real ($15 vs $30/month), but so is the potency difference. The grain-based products are not fraudulent — they contain some mycelium — but they are dramatically less potent and should not be compared to fruiting body extracts. <strong>Look for: third-party beta-glucan testing (minimum 25%), fruiting body only, country of origin (China-sourced products have higher heavy metal risk), and avoidance of grain fillers.</strong></p></section>
