  ...
  return (
    <div className='space-y-6 rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 sm:p-8'>
      ...
      <div className='flex flex-wrap gap-3'>
        <Link href='/best-supplements-for-fat-loss' className='inline-flex min-h-11 items-center rounded-2xl bg-emerald-300 px-5 py-2 font-bold text-black transition hover:bg-emerald-200 active:scale-[0.99]'>Explore Fat Loss Supplements</Link>
