...
const relatedSystems = [
  ...
  { href: '/education/why-online-supplement-claims-spread', title: 'Why Online Supplement Claims Spread' },
    ...
    <main className="container-page py-10 space-y-12">
      ...
      <section className="space-y-6 max-w-5xl">
        <div className="space-y-3">
          ...
          <h1 className="text-5xl font-bold tracking-tight text-ink">Scientific But Human Neuroscience</h1>
        </div>

        <p className="text-xl leading-9 text-[#46574d]">
          Human cognition and emotional experiences may emerge from complex interactions between stress physiology, emotional regulation, recovery biology, attentional systems, environmental context, nervous-system sensitivity, and biological variability. Scientific literacy may become stronger when neuroscience remains both evidence-aware and emotionally human.
        </p>
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        {principles.map((principle) => (
          <div key={principle.title} className="card-premium p-6 space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight text-ink">{principle.title}</h2>
            <p className="text-sm leading-7 text-[#46574d]">{principle.body}</p>
          </div>
        ))}
      </section>
      ...
      <section className="space-y-6">
        <div className="space-y-2">
          ...
          <h2 className="text-3xl font-semibold tracking-tight text-ink">Common philosophy and neuroscience questions</h2>
        </div>
      ...
      <section className="space-y-5">
        <div className="space-y-2">
          ...
          <h2 className="text-3xl font-semibold tracking-tight text-ink">Explore the broader neuroscience ecosystem</h2>
        </div>
