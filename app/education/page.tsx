    ...
    <main className="container-page py-10 space-y-16">
      ...
      <section className="space-y-8 max-w-5xl">
        ...
        <div className="space-y-5 text-lg leading-9 text-[#46574d] max-w-4xl">
          <p>
            The Hippie Scientist educational ecosystem explores neurochemistry, cognition systems, stress neurobiology, psychoactive education, recovery-oriented neuroscience, and evidence-aware neuropharmacology through a systems-oriented framework.
          </p>

          <p>
            Educational content is designed to emphasize scientific nuance, biological complexity, evidence interpretation, uncertainty awareness, and anti-oversimplification neuroscience literacy rather than sensationalized optimization narratives.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-6">
        <div className="space-y-2 max-w-3xl">
          <p className="eyebrow-label">Featured Supernodes</p>

          <h2 className="text-4xl font-semibold tracking-tight text-ink">
            Start with the major neuroscience systems
          </h2>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {supernodes.map((node) => (
            ...
            >
              <div className="space-y-4">
                <p className="eyebrow-label">Cornerstone Educational System</p>
      ...
      <section className="card-premium p-8 space-y-6">
        <div className="space-y-3 max-w-3xl">
          ...
          <p className="text-base leading-8 text-[#46574d]">
            Many neuroscience and supplement discussions online reduce complex biological systems into simplistic narratives involving single neurotransmitters, deterministic optimization frameworks, or exaggerated mechanistic claims. This educational ecosystem instead emphasizes systems biology, uncertainty awareness, contextual interpretation, evidence limitations, and scientific humility.
          </p>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          <div className="rounded-3xl border border-black/5 bg-white/60 p-6 space-y-3">
            ...
            <p className="text-sm leading-7 text-[#46574d]">
              Human evidence, mechanistic limitations, translational uncertainty, and biological variability are emphasized throughout the platform.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-black/5 bg-white/60 p-6 space-y-3">
            ...
            <p className="text-sm leading-7 text-[#46574d]">
              Stress biology, cognition systems, sleep recovery, emotional regulation, neuropharmacology, and environmental context are treated as interacting systems.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-black/5 bg-white/60 p-6 space-y-3">
            ...
            <p className="text-sm leading-7 text-[#46574d]">
              Educational content avoids sensationalized optimization narratives, simplistic neurotransmitter explanations, and exaggerated psychoactive claims.
            </p>
          </div>
        </div>
      </section>
