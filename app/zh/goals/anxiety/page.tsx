...
export default function ChineseAnxietyPage() {
  return (
    <ChinesePageShell
      ...
      description='本页不把补充剂描述为解决方案，而是帮助整理信息：哪些选择与平静感相关，哪些需要谨慎比较，以及如何区分人体证据和营销语言。'
      ...
      cards={[
        {
          title: '不要混为一谈',
          body: '担忧、紧张和睡眠不安并不是同一种情境。页面应避免把所有问题包装成一个承诺。',
        },
        {
          title: '注意组合背景',
          body: '如果已经使用会影响情绪、睡眠或清醒度的产品，放松类选择更需要谨慎比较。',
        },
        {
          title: '寻找真实证据',
      ...
      note='如果情况让你担心，请结合个人背景寻求合适的专业支持。本页仅整理教育信息。'
    />
  )
}
