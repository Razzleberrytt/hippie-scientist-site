export const herbs = [
  {
    ...
    description:
      "A Taiwanese tree whose root bark is rich in DMT and related tryptamines. Commonly used in DIY Ayahuasca analogs or 'Anahuasca' brews.",
  ...
  },
  {
    ...
    mechanismOfAction:
      'Contains \u03b2-asarone; may modulate acetylcholine and GABA pathways; traditional use for cognition.',
    onset: '15-45 min',
    ...
    sideEffects:
      'Nausea at high doses, possible carcinogenic risk with long-term \u03b2-asarone exposure.',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83d\udc8a oral', '\ud83e\udde0 cognitive'],
  ...
  },
  {
    ...
    description:
      'A sacred dream-enhancing root used by the Xhosa people of South Africa to induce powerful and meaningful dreams.',
  ...
  },
  {
    ...
    description:
      'Used in Amazonian shamanic rituals for its spiritual and anti-inflammatory effects. Often included in Ayahuasca blends.',
    drugInteractions: 'Unknown',
    duration: '2\u20136 hrs',
  ...
  },
  {
    ...
    mechanismOfAction:
      'Bufotenin acts as a potent and non-selective serotonin receptor agonist at 5-HT\u2081A, 5-HT\u2082A, 5-HT\u2082C, and 5-HT\u2083 receptors, and serves as a specific serotonin releasing agent [1, 0].',
    onset: 'Varies',
    pharmacokinetics:
      'When insufflated, bufotenin is rapidly absorbed nasally with onset in 5\u201315\u202fmin and duration around 1\u20132\u202fh [1, 1].',
    ...
    tags: ['\u26a0\ufe0f restricted'],
    therapeuticUses:
      'Traditionally used as a snuff for visionary and divinatory rituals in South American cultures [1, 1].',
    toxicity:
      'No documented human LD50; rodent LD50 approximately 200\u2013300\u202fmg/kg (intraperitoneal) [1, 0].',
    toxicityLD50:
      'No documented human LD50; rodent LD50 approximately 200\u2013300\u202fmg/kg (intraperitoneal) [1, 0].',
    affiliateLink: '',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Contains bacosides A and B which enhance cholinergic transmission, antioxidant defenses, and modulate neurotransmitter levels (serotonin, dopamine) [0, 0, 0, 2].',
    onset: '30-60 min',
    pharmacokinetics:
      'Oral preparations (extracts or powder); onset 30\u201360\u202fmin; requires chronic dosing for peak cognitive benefits [0, 5].',
    ...
    therapeuticUses:
      'Cognitive enhancement (memory, learning), anxiety reduction, ADHD management [0, 1, 0, 6].',
    toxicity:
      'Generally non-toxic; no serious adverse effects at recommended doses; rodent LD50 not well established [0, 6].',
    toxicityLD50:
      'Generally non-toxic; no serious adverse effects at recommended doses; rodent LD50 not well established [0, 6].',
    affiliateLink: '',
  ...
  },
  {
    ...
    description:
      'A widely used masticatory stimulant in Asia and the Pacific, often combined with lime and betel leaf.',
  ...
  },
  {
    ...
    contraindications: 'Pregnancy',
    description:
      'Sacred Egyptian flower associated with dream states and aphrodisiac properties. Contains aporphine alkaloids.',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Contains aporphine and nuciferine; dopamine receptor modulation and mild sedative effect.',
    onset: '1-5 min',
    pharmacokinetics:
      'Smoked or soaked in wine; onset rapid (5\u201320 min); duration ~1\u20133 hrs.',
  ...
  },
  {
    ...
    description:
      'A flowering Amazonian shrub used in master plant dieta and as an adjunct to Ayahuasca ceremonies for emotional healing and dream clarity.',
  ...
  },
  {
    ...
    description:
      'Powerful and dangerous deliriant used in South American shamanism. Highly toxic and not recommended for casual use.',
  ...
  },
  {
    ...
    description:
      'The vine of the soul used in Ayahuasca. Contains harmala alkaloids and facilitates DMT absorption in the brew.',
  ...
  },
  {
    ...
    description:
      "Known as the 'dream herb' of the Chontal people of Mexico, Calea is traditionally used to enhance dreams and mental clarity during sleep.",
  ...
  },
  {
    ...
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83c\udf00 dissociation', '\ud83e\uddd8 sedation'],
  ...
  },
  {
    ...
    contraindications: 'Pregnancy',
    description:
      "Often called the 'Intellect Tree', this Ayurvedic plant is used to support memory, learning, and vivid dreams. Contains sesquiterpenes that may stimulate cholinergic activity.",
  ...
  },
  {
    ...
    description:
      'A key component of traditional Ayahuasca brews, Chacruna contains DMT and is often combined with MAOIs like Banisteriopsis caapi to make it orally active.',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Contains \u03b2-carboline alkaloids (harmine, harmaline) and coumarins (scopoletin) that may inhibit monoamine oxidase and modulate serotonergic/cholinergic systems [0, 11, 0, 1].',
    onset: '15-45 min',
    pharmacokinetics:
      'Traditionally infused or added to ayahuasca; alkaloids absorbed orally; onset ~30\u201360\u202fmin; duration several hours [0, 10].',
    preparation: 'Amazonian brew; not casual use',
    region: '\ud83c\udf0e Unknown / Global',
    scientificName: 'Unknown',
    sideEffects: 'Dizziness, nausea, muscle tremors, delirium at high doses [0, 11].',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83c\udf00 dissociation'],
    therapeuticUses:
      'Potentiates ayahuasca, used in Amazonian rituals for introspection and mild hallucinations [0, 4].',
    toxicity: 'Toxic in high doses; caution advised.',
    toxicityLD50:
      'LD50 not established; considered mildly toxic in large doses due to cholinergic effects.',
    affiliateLink: '',
    slug: 'chiric-sanango',
  },
  {
    ...
    description:
      'Amazonian vine used in both physical and spiritual medicine. Traditionally consumed as a libido enhancer and pre-Ayahuasca preparation.',
    ...
    tags: ['\u2705 safe', '\ud83c\udf3f amazonian', '\ud83d\udd25 aphrodisiac'],
  ...
  },
  {
    ...
    description:
      'Known as Piripiri or Guinea Rush, this sedge is used in Afro-Caribbean and Amazonian rituals for mild visionary states and spiritual grounding.',
    drugInteractions: 'Unknown',
    duration: '2\u20135 hrs',
  ...
  },
  {
    ...
    description:
      'Used traditionally in Mexico and Central America for libido, relaxation, and mild stimulation. Sometimes blended in herbal smoking mixes.',
  ...
  },
  {
    ...
    description:
      'A rare South American shrub used by the Mapuche and other indigenous groups in Chile and Colombia as a ritual intoxicant. Known for unpredictable and potent effects.',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Adaptogenic modulation of HPA axis and immune response; contains eleutherosides influencing stress resilience.',
    onset: '30-60 min',
    pharmacokinetics:
      'Oral onset in 30\u201360 minutes; active glycosides metabolized hepatically.',
    preparation: 'Tea or extract',
    region: '\ud83c\udde8\ud83c\uddf3 East Asia',
    scientificName: 'Unknown',
    sideEffects: 'Mild insomnia, irritability, nervousness in high doses.',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83d\udcab euphoria'],
  ...
  },
  {
    ...
    onset: '30-60 min',
    pharmacokinetics:
      'Traditionally consumed as cold water infusion; onset ~1\u20132\u202fh; effects last ~6\u20138\u202fh [0, 11].',
    preparation: 'Seed powder or chew',
    region: '\ud83c\uddf2\ud83c\uddfd Latin America',
    scientificName: 'Unknown',
    sideEffects: 'Mild GI upset, drowsiness; rare nausea [0, 6].',
    tags: ['\u2705 safe', '\ud83d\udc8a oral', '\ud83e\udde0 dream'],
    therapeuticUses:
      'Dream enhancement, lucid dreaming, traditional remedy for diarrhea and stomach aches [0, 6, 0, 11].',
  ...
  },
  {
    ...
    drugInteractions:
      'Additive CNS depression with sedatives, barbiturates; caution with blood thinners and antihypertensives [2, 8].',
    duration: 'Unknown',
    ...
    onset: '15-45 min',
    pharmacokinetics:
      'Oral (tea, extract); onset 30\u201360\u202fmin; duration ~4\u202fh; bioavailability of key alkaloids moderate [2, 3].',
    preparation: 'Tea, tincture',
    region: '\ud83c\udf0e Unknown / Global',
    scientificName: 'Unknown',
    sideEffects:
      'High doses may cause residual sedation ("hangover"), nausea, dizziness; avoid operating machinery [2, 8, 2, 9].',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83c\udf00 dissociation', '\ud83e\uddd8 sedation'],
    therapeuticUses:
      'Anxiety reduction, insomnia aid, mild analgesic, vasomotor headache relief [2, 3, 2, 7].',
  ...
  },
  {
    ...
    description:
      'A caffeinated Amazonian holly used in dream rituals and for morning alertness. Known for smooth energy and calming clarity.',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Alkaloids may affect auditory processing and blood flow, potentially modulating neurotransmission [9, 4].',
    onset: '15-45 min',
    pharmacokinetics:
      'Traditionally fermented sun tea; slow onset 15\u201345\u202fmin; duration ~2\u20133\u202fh [9, 4].',
    preparation: 'Fermented sun tea',
    region: '\ud83c\udf0e Unknown / Global',
    scientificName: 'Unknown',
    sideEffects: 'Dry mouth, muscle relaxation, altered hearing [9, 4].',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83c\udf00 dissociation', '\ud83e\uddea fermented'],
  ...
  },
  {
    ...
    description:
      'Sacred flower in Buddhism and Hinduism, with mild psychoactive and calming properties. Often used in teas or tinctures.',
    ...
    legalStatus: 'Legal',
    mechanismOfAction:
      'Likely GABAergic and dopaminergic effects (alkaloids: nuciferine, aporphine)',
    onset: '30\u201360 min',
    pharmacokinetics: 'Onset: 30\u201360 min; Duration: 2\u20134 hrs',
  ...
  },
  {
    ...
    description:
      'A ghostly white forest plant used in Native American medicine for pain and spiritual insight. Non-photosynthetic and mysterious.',
    ...
    mechanismOfAction:
      'Contains monotropin; acts possibly on NMDA or opioid systems (hypothetical)',
    onset: '30\u201360 min',
    pharmacokinetics: 'Onset: 30\u201360 min; Duration: 2\u20134 hrs',
    ...
    tags: ['\ud83c\udf32 pain relief', '\ud83d\udc7b ghost plant', '\ud83e\udde0 emotional'],
  ...
  },
  {
    ...
    onset: '30-90 min',
    pharmacokinetics:
      'Oral ingestion onset 45\u2013120\u202fmin; duration 4\u201310\u202fh; hepatic metabolism [0, 5].',
  ...
  },
  {
    ...
    tags: ['\u2705 legal', '\ud83c\udf3f ayahuasca-additive', '\ud83e\uddd8 calm'],
  ...
  },
  {
    ...
    description:
      'A South African succulent traditionally chewed or snuffed to reduce anxiety and induce euphoria.',
  ...
  },
  {
    ...
    scientificName: 'Unknown',
    sideEffects: 'Not well documented',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83d\udc8a oral', '\ud83d\udcab euphoria'],
    therapeuticUses: 'Not well documented',
    toxicity: 'Unknown',
    toxicityLD50: 'Unknown',
    affiliateLink: '',
  ...
  },
  {
    ...
    tags: ['\u2705 safe', '\ud83c\udf3f opium lettuce', '\ud83d\ude34 sedative'],
  ...
  },
  {
    ...
    legalStatus: 'Controlled / Toxic',
    mechanismOfAction:
      'Contains tropane alkaloids (scopolamine, atropine); anticholinergic deliriant.',
    onset: 'Varies',
  ...
  },
  {
    ...
    drugInteractions:
      'May potentiate sedatives, anticoagulants; caution with CNS depressants [0, 16].',
    duration: 'Unknown',
    ...
    onset: '15-30 min',
    pharmacokinetics:
      'Oral onset 30\u201360\u202fmin; active compounds absorbed in GI tract; hepatic metabolism; renal excretion [0, 0].',
  ...
  },
  {
    ...
    description:
      'Highly sought after for its DMT-rich root bark. Used in Anahuasca brews as a substitute for chacruna or yopo.',
    ...
    tags: ['\u26a0\ufe0f visionary', '\ud83c\udf3f anahuasca', '\ud83e\uddea dmt'],
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Modulates cortisol, inflammation, and neurotransmitters; contains eugenol, ursolic acid, and apigenin.',
    onset: '15-30 min',
  ...
  },
  {
    ...
    onset: '5-15 min',
    pharmacokinetics:
      'Oral infusion onset ~30\u202fmin; duration ~4\u202fh; metabolites excreted renally [0, 7].',
    preparation: 'Smoked or tea',
    region: '\ud83c\udf0d Africa',
    scientificName: 'Unknown',
    ...
    therapeuticUses:
      'Muscle relaxant, antioxidant, antimicrobial, traditional remedy for pain and inflammation [0, 7].',
  ...
  },
  {
    ...
    description:
      'Also known as Butterbur, this European root was historically used as a remedy for migraines and spasms. Contains pyrrolizidine alkaloids, so safe extracts must be purified.',
    ...
    tags: ['\u26a0\ufe0f pa toxins', '\ud83c\udf3f herbal', '\ud83e\udde0 headache'],
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Contains safrole and other volatile oils; possible mild dopaminergic stimulation and GI modulation.',
    onset: '15-30 min',
    pharmacokinetics:
      'Oral infusion or extract onset 30\u201360\u202fmin; hepatic metabolism; renal excretion [0, 11].',
    preparation: 'Tea or culinary use',
    region: '\ud83c\udf0e Unknown / Global',
    scientificName: 'Unknown',
    sideEffects: 'High doses may cause GI upset; safrole is a potential carcinogen [1, 11].',
    tags: ['\u2615 brewable', '\u2705 safe', '\ud83d\udcab euphoria', '\ud83e\uddd8 sedation'],
    therapeuticUses:
      'Digestive aid, anti-inflammatory, antimutagen, diuretic, antipyretic [0, 11].',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Influences serotonin, norepinephrine, dopamine; modulates HPA axis and stress adaptation via rosavins and salidroside.',
    onset: '30-60 min',
    pharmacokinetics:
      'Absorbed orally; peak plasma ~1-2 hours; active compounds metabolized in liver, excreted renally.',
    preparation: 'Capsule, tincture',
    region: '\ud83c\udf0e Unknown / Global',
    scientificName: 'Unknown',
    sideEffects: 'Irritability, dry mouth, dizziness (rare, dose-dependent).',
    tags: ['\u2705 safe', '\ud83d\udc8a oral', '\ud83d\udcab euphoria', '\ud83e\udde0 cognitive'],
  ...
  },
  {
    ...
    onset: '30-90 min',
    pharmacokinetics:
      'Insufflated or ingested; onset 20\u201360\u202fmin; duration 4\u20138\u202fh; hepatic metabolism [0, 12].',
    preparation: 'Seeds ground and cold infused',
    region: '\ud83c\udf0e Unknown / Global',
    scientificName: 'Unknown',
  ...
  },
  {
    ...
    category: 'Dissociative / Sedative',
    contraindications:
      'Psychiatric disorders, cardiovascular instability; avoid in those at risk for psychosis [3, 2].',
    description: 'Mazatec entheogen with powerful, short-lived visionary effects.',
    drugInteractions:
      'CNS depressants may potentiate sedative effects; caution when coadministered [3, 3].',
    duration: 'Unknown',
    ...
    onset: '1-5 min',
    pharmacokinetics:
      'Absorbed via oral mucosa, smoking or vaporization; rapid onset (seconds\u2013minutes), short duration (~15\u201330\u202fmin), quickly metabolized to inactive salvinorin B [3, 1].',
    preparation: 'Smoked, intense, short duration',
    region: '\ud83c\uddf2\ud83c\uddfd Latin America',
    scientificName: 'Unknown',
    sideEffects:
      'Tiredness, dizziness, amnesia, potential for transient psychosis in vulnerable individuals [3, 2].',
    tags: ['\u26a0\ufe0f restricted', '\ud83c\udf00 dissociation', '\ud83c\udf2c\ufe0f smokable'],
    therapeuticUses:
      'Visionary experiences in traditional Mazatec rituals; investigated for analgesic and anti-inflammatory properties [3, 0].',
    toxicity: 'Low toxicity; animal studies show minimal organ damage even at high doses [3, 3].',
    toxicityLD50:
      'LD50 not established; salvinorin A active at microgram levels with no evidence of physical toxicity.',
    affiliateLink: '',
  ...
  },
  {
    ...
    mechanismOfAction:
      'Selective serotonin reuptake inhibition (SSRI) and phosphodiesterase-4 (PDE4) inhibition [9, 4].',
    onset: '30-60 min',
    ...
    tags: ['\u26a0\ufe0f restricted', '\ud83d\udc8a oral', '\ud83d\udcab euphoria'],
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Flavonoids and baicalin modulate GABA-A receptors and inhibit inflammation.',
    onset: '15-45 min',
  ...
  },
  {
    ...
    contraindications: 'Pregnancy, CNS depressants',
    description:
      'Commonly known as Skullcap, this North American herb has a long history in Western herbalism for treating nervous tension and insomnia.',
  ...
  },
  {
    ...
    contraindications: 'Pregnancy',
    description:
      "Known as 'Xhosa Dream Root', Silene capensis is a sacred plant used by the Xhosa people of South Africa for initiating vivid and prophetic dreams.",
    drugInteractions: 'None well documented',
    duration: '6\u20138 hrs',
    ...
    legalStatus: 'Legal',
    mechanismOfAction:
      'Likely acts on cholinergic and serotonergic systems; exact mechanism unknown',
    onset: '30\u201360 min',
  ...
  },
  {
    ...
    description:
      "Used traditionally in Central America as a 'sun opener,' believed to enhance memory and auditory perception. Alters sound and memory in dreamlike ways.",
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Coumarins (dimethylfraxetin, herniarin) and essential oils (methyl eugenol, estragole) interact with GABA\u2090 and 5-HT\u2081\u2090 receptors, producing anxiolytic and sedative effects [2, 2, 2, 10].',
    onset: '1-5 min',
    pharmacokinetics:
      'Consumed as tea or tincture; onset ~20\u201330\u202fmin; duration ~2\u20134\u202fhours [2, 2].',
  ...
  },
  {
    ...
    description:
      'A powerful and dangerous tropane alkaloid plant traditionally used in witchcraft and shamanic rituals. Highly toxic.',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Likely modulates serotonin, dopamine, and GABA neurotransmission via flavonoids and tannins [8, 6].',
    onset: '1-5 min',
    pharmacokinetics:
      'Tea or smoked; onset ~30\u201345\u202fmin; duration ~2\u20134\u202fhours [8, 6].',
    preparation: 'Tea or smoke',
  ...
  },
  {
    ...
    contraindications: 'Pregnancy',
    description:
      'Closely related to Damiana (Turnera diffusa), this species is also used traditionally in folk medicine for reproductive health and mood.',
    drugInteractions: 'Unknown',
    duration: '2\u20134 hrs',
  ...
  },
  {
    ...
    description:
      'Known as stinging nettle, this European herb has been used for centuries to relieve joint pain, allergies, and fatigue. Its psychoactivity is subtle, mostly somatic.',
    ...
    tags: ['\u2705 safe', '\ud83c\udf3f anti-inflammatory', '\ud83e\uddd8 mild'],
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Mild central sedative via salicylates and alkaloids; may influence serotonin and prostaglandin pathways.',
    onset: '15-30 min',
  ...
  },
  {
    ...
    mechanismOfAction:
      'Contains DMT, 5-MeO-DMT, and beta-carbolines; classic tryptamine entheogen profile.',
    onset: '1-3 min',
    ...
    tags: ['\u26a0\ufe0f restricted'],
    therapeuticUses:
      'Used in Amazonian shamanic healing rituals; possible antidepressant potential.',
  ...
  },
  {
    ...
    description:
      'A snuff plant from the Amazon containing DMT and 5-MeO-DMT. Used by Yanomami and other tribes for potent visionary rituals.',
    drugInteractions: 'MAOIs, antidepressants',
    duration: '20\u201360 min',
  ...
  },
  {
    ...
    description:
      'A powerful African plant containing voacangine and iboga alkaloids. Used traditionally in ritual contexts and studied as a potential ibogaine precursor.',
    ...
    mechanismOfAction:
      'Voacangine is a prodrug to ibogaine (NMDA antagonist, serotonin transporter blocker)',
    onset: '30\u201390 min',
  ...
  },
  {
    ...
    contraindications: 'Pregnancy',
    description:
      'Related to Blue Lotus, this sacred flower from Mesoamerican traditions is used to promote meditation and lucid dreaming.',
    drugInteractions: 'Avoid CNS depressants',
    duration: '2\u20134 hrs',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      '1,8-Cineole and \u03b1-thujone inhibit pro-inflammatory cytokines (TNF\u03b1, IL-1\u03b2) and arachidonic acid metabolism; antimicrobial and antiviral effects via NF-\u03baB inhibition [0, 19, 0, 4].',
    onset: '5-20 min',
    pharmacokinetics:
      'Inhaled or topical; rapid local absorption; systemic exposure minimal; metabolites excreted renally [0, 4].',
    preparation: 'Burned as incense',
    region: '\ud83c\udf10 Global / Ritual',
    scientificName: 'Unknown',
    sideEffects:
      'Respiratory irritation, asthmatic exacerbation, headaches at high exposure [0, 19].',
    tags: [
      '\u2705 safe',
      '\ud83d\udd2e ritual',
      '\ud83d\udd6f\ufe0f ritual',
    ...
    therapeuticUses:
      'Smudging rituals for purification, antimicrobial, respiratory support, mental clarity [0, 19].',
  ...
  },
  {
    ...
    legalStatus: 'Legal / Unregulated',
    mechanismOfAction:
      'Modulates GABAergic and serotonergic activity; reduces cortisol; withanolides are primary active compounds.',
    onset: '30-60 min',
    pharmacokinetics:
      'Oral onset 30\u201360\u202fmin; withanolides bioavailable; hepatic metabolism; renal excretion [0, 17].',
    ...
    therapeuticUses:
      'Adaptogen, anti-stress, anxiolytic, neuroprotective, anti-inflammatory, immune support [0, 1, 0, 17].',
  ...
  },
  {
    ...
    description:
      'Key ingredient in absinthe. Contains thujone, which is a GABA_A antagonist and neurostimulant in high doses. Historically used for dreaming, digestion, and ritual.',
  ...
  },
  {
    ...
    description:
      'South American herbal stimulant rich in caffeine, theobromine, and theophylline. Traditionally shared as a communal energizing tea.',
  ...
  },
  {
    ...
    description:
      'Used in Amazonian rituals, Yopo seeds are ground and insufflated to induce powerful entheogenic experiences. Contains bufotenine, DMT, and 5-MeO-DMT.',
  ...
  },
  {
    ...
    category: 'Ritual / Visionary',
    tags: ['\u26a0\ufe0f caution', '\ud83c\udf44 mushroom'],
    effects: ['Euphoria', 'dissociation', 'dreamlike state'],
    mechanismOfAction:
      'Ibotenic acid and muscimol act as GABA agonists and NMDA antagonists after decarboxylation.',
    ...
    description:
      'Iconic red-capped mushroom used in Siberian shamanism and folklore. Psychoactive when properly prepared.',
    affiliateLink: '',
    id: 'Unknown',
  ...
  },
  {
    ...
    therapeuticUses:
      'Used in Middle Eastern rituals; sometimes combined with DMT for oral activity.',
  ...
  },
  {
    ...
    description:
      'Orange-flowered shrub also called lion\u2019s tail; smoked traditionally for mild cannabis-like effects.',
    affiliateLink: '',
    id: 'Unknown',
    slug: 'wild-dagga',
  },
  {
    ...
    mechanismOfAction:
      'Yohimbine blocks alpha-2 adrenergic receptors leading to increased norepinephrine release.',
    ...
    description:
      'West African tree bark rich in yohimbine, historically used as an aphrodisiac and stimulant.',
    affiliateLink: '',
    id: 'Unknown',
    slug: 'yohimbe',
  },
  {
    ...
    description:
      'Evergreen shrub whose fresh leaves are chewed for stimulant and euphoric effects in social settings.',
    affiliateLink: '',
    id: 'Unknown',
    slug: 'khat',
  },
  {
    ...
    mechanismOfAction:
      'Caffeine antagonizes adenosine receptors; L-theanine modulates glutamate and GABA.',
    ...
    description:
      'Source of green and black tea; contains caffeine and theanine for balanced stimulation.',
    affiliateLink: '',
    id: 'Unknown',
  ...
  },
  {
    ...
    tags: ['\u26a0\ufe0f potent', '\ud83c\udf3f ma huang'],
    effects: ['Energy boost', 'bronchodilation'],
    mechanismOfAction:
      'Ephedrine and pseudoephedrine stimulate adrenergic receptors and release norepinephrine.',
    ...
    description:
      'Shrubby plant known as Ma Huang; source of ephedrine used both medicinally and recreationally.',
    affiliateLink: '',
    id: 'Unknown',
    slug: 'ephedra-sinica',
  },
  {
    ...
    mechanismOfAction:
      'Safrole may modulate dopamine release and acts as a mild hallucinogen at high doses.',
    ...
    description:
      'Fragrant tree whose root bark and oil were once common flavorings; contains safrole with mild psychoactive properties.',
    affiliateLink: '',
    id: 'Unknown',
    slug: 'sassafras',
  },
  {
    ...
    description:
      'Climbing plant native to Brazil; its seeds provide a potent caffeine kick and are popular in energy drinks.',
    affiliateLink: '',
    id: 'Unknown',
    slug: 'guarana',
  },
  {
    ...
    mechanismOfAction:
      'Seeds contain ergoline alkaloids (LSA) that act on serotonin receptors similarly to LSD but with milder potency.',
    therapeuticUses:
      'Occasional spiritual or introspective use; historically as ornamental and traditional medicine.',
    ...
    description:
      'Climber with heart-shaped leaves; its seeds contain LSA and are used as a legal alternative to LSD experiences.',
    affiliateLink: '',
    id: 'Unknown',
  ...
  },
  {
    ...
    category: 'Ritual / Visionary',
    tags: ['\u26a0\ufe0f intense', '\ud83c\udf3f root bark'],
    effects: ['Powerful visions', 'spiritual insight', 'stimulation'],
    mechanismOfAction:
      'Ibogaine acts on NMDA, kappa-opioid, and serotonin systems while promoting neurotrophic factors.',
    ...
    description:
      'Sacred shrub central to Bwiti ceremonies; contains ibogaine producing intense visionary states and potential addiction therapy.',
    affiliateLink: '',
    id: 'Unknown',
  ...
  },
  {
    ...
    region: '\ud83c\udf0e Synthetic',
    tags: ['\u26a0\ufe0f restricted', '\ud83c\udf00 visionary', '\ud83d\udc8a oral'],
    mechanismOfAction: 'Potent 5-HT2A receptor agonist affecting serotonin and dopamine systems.',
    pharmacokinetics:
      'Oral administration with effects lasting 8-12 h; hepatic metabolism to inactive metabolites.',
  ...
  },
  {
    ...
    category: 'Ritual / Visionary',
    tags: ['australian', 'dmt', 'tree'],
    effects: ['strong visuals', 'mystical experience', 'euphoria'],
    mechanismOfAction:
      'Root bark contains DMT that acts as a 5\u2011HT2A agonist; requires MAOI inhibition for oral activity',
    therapeuticUses: 'Used in entheogenic brews for introspection and spiritual healing',
    pharmacokinetics:
      'Smoked onset 2\u20133\u202fmin, duration 15\u201330\u202fmin; oral with MAOI onset 20\u201345\u202fmin, duration 4\u20136\u202fh',
    ...
    description:
      'Australian acacia tree whose bark is rich in DMT and sometimes used in ayahuasca analogues.',
    id: 'acacia-maidenii',
    affiliateLink: '',
  ...
  },
  {
    ...
    description:
      'Fragrant wetland herb known as Sweet Flag; historically used for relaxation and vivid dreams.',
    id: 'acorus-calamus',
    affiliateLink: '',
    slug: 'acorus-calamus',
  },
  {
    ...
    therapeuticUses:
      'Traditional Chinese medicine uses the bark and flowers as a calming antidepressant',
    ...
    description:
      'Often called Persian silk tree; valued in Asian herbalism for its tranquil and mood-brightening properties.',
  ...
  },
  {
    ...
    tags: ['anodyne', 'folk', 'sedative'],
    effects: ['calm', 'pain relief', 'mild altered awareness'],
    mechanismOfAction:
      'Contains lactones derived from protoanemonin that depress the central nervous system',
    ...
    description:
      'Also called Pasque Flower; once used by herbalists for calming nerves and relieving pain.',
  ...
  },
  {
    ...
    category: 'Sedative / Analgesic',
    tags: ['alkaloid', 'folk medicine', 'poppy'],
    ...
    therapeuticUses:
      'Mexican and Ayurvedic traditions use it for pain, insomnia and mild narcotic effects',
    ...
    description:
      'Spiny yellow poppy whose milky latex was historically used for pain relief and sedation.',
  ...
  },
  {
    ...
    mechanismOfAction:
      'Leaves contain combretol and related alkaloids acting on adrenergic systems',
    ...
    description:
      'Often marketed as \u201cSakae Naa,\u201d this plant is used as a mild energizing substitute for kratom.',
  ...
  },
  {
    ...
    description:
      'Tubers of this Asian herb provide notable pain relief and a tranquil state when used as tea or pills.',
  ...
  },
  {
    ...
    pharmacokinetics:
      'Smoked onset 2\u20133\u202fmin; oral with MAOI onset 20\u201345\u202fmin; duration up to 6\u202fh',
    toxicity: 'Low physiological, high psychological risk',
    toxicityLD50: 'Not established',
    intensity: 'Strong',
    onset: '2\u201345\u202fmin depending on route',
    ...
    drugInteractions: 'Dangerous with MAOIs or serotonergic drugs',
    description:
      'Also called Illinois Bundleflower; its root bark contains notable amounts of DMT.',
  ...
  },
  {
    ...
    description:
      'Flowering tree whose bark is prized in Brazilian folk medicine for calming nerves and promoting sleep.',
  ...
  },
  {
    ...
    description:
      'Known locally as Color\u00edn; its red flowers are brewed into a soothing bedtime drink.',
  ...
  },
  {
    ...
    description:
      'Rare rainforest tree providing psychoactive bark traditionally used in New Guinea for visionary experiences.',
  ...
  },
  {
    ...
    category: 'Stimulant',
    tags: ['aromatic', 'galangal', 'spice'],
    effects: ['warm stimulation', 'mild euphoria', 'enhanced circulation'],
    mechanismOfAction:
      'Contains eugenol and cineole that increase circulation and mild CNS stimulation',
    ...
    description:
      'A common culinary spice known as galangal that offers gentle stimulation and a warming effect.',
    id: 'alpinia-galanga',
    affiliateLink: '',
  ...
  },
  {
    ...
    therapeuticUses:
      'Used in Latin American and Asian folk medicine for relaxation and spiritual rituals',
    pharmacokinetics:
      'Onset 20\u201330\u202fmin when smoked or brewed; effects last 2\u20134\u202fh',
    ...
    drugInteractions: 'May enhance effects of other sedatives',
    description:
      'Sometimes called Marihuanilla or Siberian motherwort, providing gentle calming effects and subtle dreaminess.',
  ...
  },
  {
    ...
    tags: ['central asia', 'calming', 'intoxicating mint'],
    ...
    description:
      'Known as intoxicating mint; produces a pleasant calm and slight euphoria when brewed.',
  ...
  },
  {
    ...
    mechanismOfAction:
      'High nicotine plus MAO\u2011inhibiting beta\u2011carbolines stimulate nicotinic receptors and inhibit MAO',
    therapeuticUses: 'Used by Amazonian shamans for cleansing and focus',
    pharmacokinetics:
      'Smoked onset immediate, duration 30\u201360\u202fmin; oral snuff onset ~5\u202fmin',
    ...
    description:
      'Potent tobacco species used ceremonially in the Amazon, far stronger than common N. tabacum.',
  ...
  },
  {
    ...
    description:
      'Also called the Egyptian white lotus, historically revered for its gentle calming and dreamlike qualities.',
    id: 'nymphaea-lotus',
    affiliateLink: '',
    slug: 'nymphaea-lotus',
  },
  {
    ...
    category: 'Ritual / Visionary',
    tags: ['amazon', 'dmt', 'chaliponga'],
    effects: ['visual effects', 'introspection', 'spiritual insight'],
    mechanismOfAction:
      'Leaves contain N,N-dimethyltryptamine acting as a serotonin agonist; requires MAO inhibition orally',
    ...
    description:
      'Amazonian shrub also known as Chaliponga; its DMT-rich leaves are valued in shamanic ceremonies.',
  ...
  },
  {
    ...
    category: 'Stimulant / Nootropic',
    tags: ['ayurveda', 'dopamine', 'velvet bean'],
    ...
    description:
      'Also called Velvet Bean; boosts dopamine and serves as a traditional tonic in Ayurvedic practice.',
    id: 'mucuna-pruriens',
    affiliateLink: '',
  ...
  },
  {
    ...
    description:
      'Liana used by several Amazonian tribes; the bark yields a potent caffeinated beverage for energy.',
    id: 'paullinia-yoco',
    affiliateLink: '',
    slug: 'paullinia-yoco',
  },
  {
    ...
    description:
      'Fragrant African shrub sometimes called Iboza; provides a relaxing effect and mild pain relief.',
  ...
  },
  {
    ...
    tags: ['amazon', 'uchu sanango', 'iboga alkaloids'],
    ...
    description:
      'Also called Uchu Sanango; this rare shrub contains iboga-like compounds and is used in shamanic practices.',
  ...
  },
  {
    ...
    mechanismOfAction:
      'Resin rich in sesquiterpenes acts via GABAergic and dopaminergic pathways when inhaled',
    therapeuticUses: 'Used in traditional Asian medicine and incense for calming and meditation',
    pharmacokinetics:
      'Effects appear within minutes when smoked or heated, lasting 1\u20132\u202fh',
    ...
    description:
      'Source of precious agarwood resin, producing a soothing aroma and subtle psychoactive calm when burned.',
  ...
  },
  {
    ...
    description:
      'Close relative of Hawaiian Baby Woodrose with LSA\u2011containing seeds used in some Indian traditions.',
  ...
  },
  {
    ...
    tags: ['north america', 'tingling', 'toothache tree'],
    effects: ['mouth numbness', 'mild stimulation', 'pain relief'],
    mechanismOfAction:
      'Bark contains sanshools that cause paresthesia and stimulate trigeminal nerves',
    ...
    description:
      'Also called the toothache tree; its bark creates a tingling numbness and light stimulation when chewed.',
  ...
  },
  {
    ...
    tags: ['ayurveda', 'respiratory', 'vasaka'],
    effects: ['clear breathing', 'mild stimulation', 'warming'],
    mechanismOfAction:
      'Alkaloids such as vasicine act as bronchodilators and respiratory stimulants',
    ...
    description:
      'Known as Vasaka or Malabar nut, this shrub\u2019s leaves ease breathing and offer a subtle stimulating effect.',
    id: 'adhatoda-vasica',
    affiliateLink: '',
  ...
  },
  {
    ...
    tags: ['muscimol', 'mushroom', 'panther cap'],
  ...
  },
  {
    ...
    tags: ['lamiaceae', 'painted nettle', 'visionary'],
  ...
  },
  {
    ...
    tags: ['san pedro', 'cactus', 'mescaline'],
  ...
  },
  {
    ...
    category: 'Stimulant',
    tags: ['andes', 'alkaloid', 'coca leaf'],
    effects: ['alertness', 'reduced fatigue', 'mild euphoria'],
    mechanismOfAction:
      'Leaves contain cocaine acting as a dopamine and norepinephrine reuptake inhibitor',
  ...
  },
  {
    ...
    tags: ['ancient', 'blood flow', 'memory'],
    effects: ['improved cognition', 'circulation boost', 'alertness'],
    mechanismOfAction:
      'Flavone glycosides and terpenoids enhance blood flow and modulate neurotransmission',
  ...
  },
  {
    ...
    tags: ['south africa', 'imphepho', 'smoke'],
  ...
  },
  {
    ...
    tags: ['maoi', "st. john's wort", 'mood'],
    effects: ['improved mood', 'reduced anxiety', 'light sedation'],
    mechanismOfAction:
      'Hyperforin and hypericin inhibit reuptake of serotonin, dopamine, and norepinephrine',
  ...
  },
  {
    ...
    category: 'Stimulant / Ritual',
    tags: ['north america', 'caffeine', 'yaupon'],
  ...
  },
  {
    ...
    legalStatus: 'Legal',
    region: 'Indonesia',
    tags: ['\u26a0\ufe0f caution', '\ud83c\udf3f seed', '\ud83e\uddea phenethylamine'],
  ...
  },
  {
    ...
    legalStatus: 'Controlled in many countries',
    region: 'Worldwide',
    tags: ['\u26a0\ufe0f caution', '\ud83c\udf44 fungus', '\ud83e\uddea alkaloid'],
  ...
  },
  {
    ...
    mechanismOfAction:
      'Sesquiterpene lactones like chamazulene reduce inflammation and may calm nerves',
    activeConstituents: [
      {
        name: 'chamazulene',
        type: 'terpene',
