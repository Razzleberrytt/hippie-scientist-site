...
export const newCompounds_11 = [
  // Batch 2
  {
    name: 'Desfontainin',
    type: 'Alkaloid',
    effects: ['deliriant', 'sedative'],
    foundIn: ['Desfontainia spinosa'],
  },
  {
    name: 'LSA (Lysergic Acid Amide)',
    type: 'Ergoline alkaloid',
    effects: ['psychedelic', 'visual enhancement', 'dreamlike'],
    foundIn: ['Argyreia nervosa'],
  },
  {
    name: 'Petasin',
    type: 'Sesquiterpene',
  ...
  // Batch 4
  {
    name: 'Damianin',
    type: 'Terpenoid',
    effects: ['aphrodisiac', 'calming', 'mild stimulant'],
    foundIn: ['Turnera diffusa'],
  },
  {
    name: 'Cineole',
    type: 'Monoterpene',
    effects: ['clarity', 'stimulating', 'antibacterial'],
    foundIn: ['Salvia apiana'],
  },
  {
    name: 'Rosmarinic acid',
    type: 'Phenolic compound',
    effects: ['antioxidant', 'cognitive support'],
    foundIn: ['Salvia apiana'],
  },
  {
    name: 'Verbenalin',
    type: 'Iridoid glycoside',
    effects: ['sedative', 'relaxing', 'dream-inducing'],
    foundIn: ['Verbena officinalis'],
  },
]

// ---- File: newEntries_Batch16.ts ----
export const newHerbs_11 = [
  {
    name: 'Tilia europaea',
    slug: 'tilia-europaea',
...
export const herbsBatch26 = [
  {
    name: 'Pimenta dioica',
    slug: 'pimenta-dioica',
    description:
      'Also known as Allspice, this Caribbean plant has mild uplifting and warming effects, sometimes used in ritual incense.',
    region: 'Caribbean, Central America',
  ...
  },
  {
    ...
    slug: 'lactuca-virosa',
    description:
      "Wild Lettuce, a traditional sedative and pain reliever in folk medicine, sometimes called 'lettuce opium'.",
    region: 'Europe',
  ...
  },
  {
    ...
    description:
      'Yarrow, used for divination and as a calming tea. Some varieties contain mild psychoactive compounds.',
    region: 'Europe, North America',
  ...
  },
  {
    ...
    slug: 'peumus-boldus',
    description:
      'Boldo is a South American medicinal herb with liver-supportive and mild hypnotic properties.',
    region: 'Chile',
  ...
  },
  {
    ...
    slug: 'vitex-agnus-castus',
    description:
      'Chasteberry is traditionally used for hormonal balancing, mood stabilization, and dream clarity.',
  ...
  },
  {
    ...
    slug: 'myristica-fragrans',
    description:
      'Nutmeg, psychoactive in high doses, has deliriant and sedative properties. Historically used in mystic rituals.',
    region: 'Indonesia',
  ...
  },
  {
    ...
    description:
      'False Indigo Bush, native to North America, was historically smoked for relaxation and vision-induction.',
    region: 'North America',
  ...
  },
  {
    ...
    description:
      'Siberian Ginseng is an adaptogen used to enhance endurance, mental resilience, and reduce fatigue.',
  ...
  },
  {
    ...
    slug: 'verbena-officinalis',
    description:
      'Vervain is a calming and spiritually symbolic herb used in ritual baths and teas.',
  ...
  },
  {
    ...
    slug: 'melissa-officinalis',
    description:
      'Lemon Balm is a gentle nervine herb that promotes calmness and sleep with subtle mood elevation.',
...
export const herbBlurbs: Record<string, string> = {
  ...
  'Acorus calamus':
    'Acorus calamus is known for its Sedative, Dream-enhancing, Stimulant (low dose) effects.',
  'Acorus gramineus':
    'Acorus gramineus is known for its Mildly calming, Cognitive-enhancing, Dream potentiator effects.',
  'Adhatoda vasica':
    'Adhatoda vasica is known for its Bronchodilator, Mild stimulant, Expectorant effects.',
  'Aegle marmelos':
    'Aegle marmelos is known for its Digestive tonic, Anti-inflammatory, Cooling effects.',
  'African Dream Root':
    'African Dream Root is known for its Vivid dreams, Lucid dreaming, Mild sedative effects.',
  'Albizia julibrissin':
    'Albizia julibrissin is known for its Mood-lifting, Anti-anxiety, Sedative effects.',
  'Alchornea castaneifolia':
    'Alchornea castaneifolia is known for its Anti-inflammatory, Analgesic, Ayahuasca synergist effects.',
  'Alpinia galanga':
    'Alpinia galanga is known for its Stimulant, Cognitive-enhancing, Aphrodisiac effects.',
  'Amanita muscaria': 'Amanita muscaria is known for its Sedation, Euphoria, Confusion effects.',
  'Anadenanthera colubrina':
    'Anadenanthera colubrina is known for its Visual hallucinations, Disorientation, Euphoria effects.',
  'Anadenanthera peregrina':
    'Anadenanthera peregrina is known for its Intense visuals, Out-of-body experience, Altered time perception effects.',
  'Argyreia nervosa':
    'Argyreia nervosa is known for its Euphoria, Time distortion, Closed-eye visuals effects.',
  'Argyreia speciosa':
    'Argyreia speciosa is known for its Aphrodisiac, Mild sedative, Nootropic (traditional) effects.',
  'Artemisia absinthium':
    'Artemisia absinthium is known for its Euphoria, Mild hallucinations, Stimulation effects.',
  'Arundo donax':
    'Arundo donax is known for its Unverified hallucinations, Mild sedation, Traditionally visionary (claimed) effects.',
  'Asarum canadense':
    'Asarum canadense is known for its Warming, Digestive stimulant, Mild sedation effects.',
  'Asclepias syriaca':
    'Asclepias syriaca is known for its Mild sedation, Cardiac influence, Anti-inflammatory effects.',
  'Avena sativa':
    'Avena sativa is known for its Mild euphoria, Anxiolytic, Nourishing tonic effects.',
  'Banisteriopsis caapi':
    'Banisteriopsis caapi is known for its MAOI potentiation, Euphoria, Emotional release effects.',
  'Brunfelsia grandiflora':
    'Brunfelsia grandiflora is known for its Altered perception, Hallucinations, Sedation effects.',
  'Brugmansia suaveolens':
    'Brugmansia suaveolens is known for its True hallucinations, Amnesia, Delirium effects.',
  'Caesalpinia sepiaria':
    'Caesalpinia sepiaria is known for its Stimulation, Increased stamina, Traditional energizing effects.',
  'Calliandra angustifolia':
    'Calliandra angustifolia is known for its Heart-opening, Dreamlike calm, Energetic cleansing effects.',
  'Camellia sinensis':
    'Camellia sinensis is known for its Alertness, Calm focus, Mood elevation effects.',
  'Camellia japonica':
    'Camellia japonica is known for its Skin soothing, Antioxidant, Mild anti-inflammatory effects.',
  'Cananga odorata': 'Cananga odorata is known for its Euphoria, Relaxation, Aphrodisiac effects.',
  'Cannabis sativa':
    'Cannabis sativa is known for its Euphoria, Relaxation, Altered perception effects.',
  'Capsicum annuum':
    'Capsicum annuum is known for its Stimulation, Endorphin release, Heat sensation effects.',
  'Celastrus paniculatus':
    'Celastrus paniculatus is known for its Memory enhancement, Mental clarity, Mild stimulation effects.',
  'Calea ternifolia':
    'Calea ternifolia is known for its Lucid dreaming, Vivid dreams, Mild sedation effects.',
  'Campsiandra angustifolia':
    'Campsiandra angustifolia is known for its Anti-inflammatory, Aphrodisiac, Tonic effects.',
  'Carica papaya':
    'Carica papaya is known for its Digestive support, Antiparasitic, Anti-inflammatory effects.',
  'Catha edulis':
    'Catha edulis is known for its Euphoria, Increased alertness, Sociability effects.',
  Catuaba: 'Catuaba is known for its Stimulation, Enhanced libido, Mild euphoria effects.',
  'Centella asiatica':
    'Centella asiatica is known for its Memory enhancement, Wound healing, Stress reduction effects.',
  'Cestrum nocturnum':
    'Cestrum nocturnum is known for its Sedation, Headache (aroma), Potential hallucinations (in folklore) effects.',
  'Cichorium intybus':
    'Cichorium intybus is known for its Liver support, Mild stimulant (roasted), Prebiotic effects.',
  'Cissampelos pareira':
    'Cissampelos pareira is known for its Uterine tonic, Muscle relaxant, Antimalarial effects.',
  'Claviceps purpurea':
    'Claviceps purpurea is known for its Vasoconstriction, Hallucinations, Convulsions effects.',
  'Clitoria ternatea':
    'Clitoria ternatea is known for its Cognitive enhancement, Anxiolytic, Neuroprotective effects.',
  'Cola acuminata':
    'Cola acuminata is known for its Stimulation, Increased alertness, Mood elevation effects.',
  'Combretum quadrangulare':
    'Combretum quadrangulare is known for its Mild stimulation, Mental clarity, Sociability effects.',
  Shankhpushpi:
    'Shankhpushpi is known for its Memory enhancement, Stress reduction, Mental clarity effects.',
  'Corydalis yanhusuo':
    'Corydalis yanhusuo is known for its Pain relief, Sedation, Muscle relaxation effects.',
  'Crataegus monogyna':
    'Crataegus monogyna is known for its Heart tonic, Circulation support, Anxiolytic effects.',
  'Crocus sativus':
    'Crocus sativus is known for its Euphoria, Antidepressant, Cognitive support effects.',
  Turmeric: 'Turmeric is known for its Anti-inflammatory, Antioxidant, Liver tonic effects.',
  'Cytisus scoparius':
    'Cytisus scoparius is known for its Cardiac stimulation, Diuretic, Mood elevation effects.',
  'Datura inoxia':
    'Datura inoxia is known for its Intense delirium, Anticholinergic trance, Hallucinations effects.',
  'Desmodium gangeticum':
    'Desmodium gangeticum is known for its Nervine support, Anti-inflammatory, Rejuvenation effects.',
  'Derris elliptica':
    'Derris elliptica is known for its Paralysis (insects/fish), Mild euphoria (folklore), Toxicity effects.',
  'Dioscorea villosa':
    'Dioscorea villosa is known for its Hormone balance, Menstrual relief, Anti-inflammatory effects.',
  'Duboisia hopwoodii':
    'Duboisia hopwoodii is known for its Stimulation, Alertness, Appetite suppression effects.',
  'Echinopsis pachanoi':
    'Echinopsis pachanoi is known for its Euphoria, Hallucinations, Empathy effects.',
  'Siberian Ginseng':
    'Siberian Ginseng is known for its Fatigue resistance, Immune modulation, Mental stamina effects.',
  'Ephedra sinica':
    'Ephedra sinica is known for its Stimulation, Appetite suppression, Bronchodilation effects.',
  'California Poppy':
    'California Poppy is known for its Mild sedation, Anxiety relief, Sleep enhancement effects.',
  'Erythrina mulungu':
    'Erythrina mulungu is known for its Anxiety relief, Sedation, Muscle relaxation effects.',
  'Espeletia grandiflora':
    'Espeletia grandiflora is known for its Cough relief, Lung support, Anti-inflammatory effects.',
  'Tongkat Ali':
    'Tongkat Ali is known for its Testosterone boost, Energy, Stress resilience effects.',
  'Galphimia glauca':
    'Galphimia glauca is known for its Anxiety relief, Tranquility, Sleep aid effects.',
  'Gastrodia elata':
    'Gastrodia elata is known for its Calms the liver, Relieves tremors, Supports cognition effects.',
  'Gelsemium sempervirens':
    'Gelsemium sempervirens is known for its Muscle relaxation, Nervous system inhibition, Pain relief effects.',
  'Genipa americana':
    'Genipa americana is known for its Skin staining, Mild antibacterial, Cooling sensation effects.',
  'Ginkgo biloba':
    'Ginkgo biloba is known for its Cognitive enhancement, Circulation support, Antioxidant effects.',
  'Gliricidia sepium':
    'Gliricidia sepium is known for its Topical antiparasitic, Wound healing, Insect repellent effects.',
  'Gymnema sylvestre':
    'Gymnema sylvestre is known for its Suppresses sweet taste, Regulates blood sugar, Supports pancreas effects.',
  'Heimia salicifolia':
    'Heimia salicifolia is known for its Dream enhancement, Auditory distortion, Relaxation effects.',
  'Lion’s Mane':
    'Lion’s Mane is known for its Nerve growth, Memory enhancement, Mood support effects.',
  Roselle: 'Roselle is known for its Blood pressure reduction, Cooling, Diuretic effects.',
  'Hyoscyamus niger':
    'Hyoscyamus niger is known for its Hallucinations, Disorientation, Sedation effects.',
  Guayusa: 'Guayusa is known for its Smooth stimulation, Vivid dreams, Antioxidant effects.',
  'Yerba Mate':
    'Yerba Mate is known for its Mental alertness, Appetite control, Social energy effects.',
  'Garden Balsam':
    'Garden Balsam is known for its Wound healing, Antimicrobial, Anti-itch effects.',
  'Morning Glory (Heavenly Blue)':
    'Morning Glory (Heavenly Blue) is known for its Visual distortions, Dream-like state, Nausea effects.',
  'Justicia pectoralis':
    'Justicia pectoralis is known for its Mild euphoria, Calm, Slight analgesia effects.',
  Kanna: 'Kanna is known for its Euphoria, Reduced anxiety, Social enhancement effects.',
  Peppermint:
    'Peppermint is known for its Soothes digestion, Stimulates focus, Relieves cramps effects.',
  'Lobelia inflata':
    'Lobelia inflata is known for its Bronchodilation, Muscle relaxation, Emetic (high dose) effects.',
  Peyote: 'Peyote is known for its Visuals, Emotional opening, Ego dissolution effects.',
  'Club Moss':
    'Club Moss is known for its Cognitive stimulation (mild), Digestive tonic, Symbolic use effects.',
  ...
  'White Horehound':
    'White Horehound is known for its Expectorant, Digestion support, Cough relief effects.',
  ...
  'Mimosa pudica':
    'Mimosa pudica is known for its Intestinal cleanse, Antiparasitic, Calming effects.',
  'Mitragyna hirsuta':
    'Mitragyna hirsuta is known for its Mild euphoria, Calm stimulation, Analgesia effects.',
  Kratom: 'Kratom is known for its Energy, Euphoria, Pain relief effects.',
  'Mucuna pruriens':
    'Mucuna pruriens is known for its Mood boost, Motivation, Hormonal support effects.',
  ...
  'American Yellow Lotus':
    'American Yellow Lotus is known for its Tranquility, Heart-opening, Sensual awareness effects.',
  'Red/Blue Water Lily':
    'Red/Blue Water Lily is known for its Calm euphoria, Sensual clarity, Dream enhancement effects.',
  Catnip: 'Catnip is known for its Relaxation, Mild euphoria, Digestive aid effects.',
  'Holy Basil':
    'Holy Basil is known for its Stress reduction, Mental clarity, Immune modulation effects.',
  Guaraná: 'Guaraná is known for its Energy, Focus, Mood boost effects.',
  'Mexican Pepperleaf':
    'Mexican Pepperleaf is known for its Digestive aid, Calming, Flavor enhancer effects.',
  Sinicuichi:
    'Sinicuichi is known for its Euphoria, Auditory hallucinations, Memory enhancement effects.',
  'Wild Dagga': 'Wild Dagga is known for its Mild euphoria, Relaxation, Tranquility effects.',
  Motherwort:
    'Motherwort is known for its Heart regulation, Menstrual balance, Anxiety relief effects.',
  'Indian Tobacco':
    'Indian Tobacco is known for its Bronchodilation, Spasm relief, Nausea (high doses) effects.',
  'Mimosa hostilis':
    'Mimosa hostilis is known for its Vivid dreams, Entheogenic visions (with MAOI), Wound healing effects.',
  ...
  'Uva Ursi':
    'Uva Ursi is known for its Urinary tract support, Astringent, Anti-inflammatory effects.',
  ...
  'Syrian Rue':
    'Syrian Rue is known for its MAOI activity, Psychedelic potentiation, Meditative calm effects.',
  Chacruna:
    'Chacruna is known for its Psychedelic visions, Emotional processing, Spiritual insight effects.',
  ...
  'Root Beer Plant':
    'Root Beer Plant is known for its Calming, Digestive aid, Appetite stimulation effects.',
  'Rhodiola rosea':
    'Rhodiola rosea is known for its Fatigue reduction, Stress resilience, Mental clarity effects.',
  'Xhosa Dream Root':
    'Xhosa Dream Root is known for its Lucid dreaming, Vivid dreams, Subtle euphoria effects.',
  Pinkroot:
    'Pinkroot is known for its Parasitic cleanse, Mild sedation, Vision changes (in excess) effects.',
  'Mexican Tarragon':
    'Mexican Tarragon is known for its Mild euphoria, Vision enhancement, Lucid dreaming effects.',
  ...
  'Chaste Tree':
    'Chaste Tree is known for its Hormone regulation, Menstrual cycle balancing, Mood support effects.',
  'Tylophora indica':
    'Tylophora indica is known for its Asthma relief, Anti-allergy, Immunoregulation effects.',
  ...
  'Grains of Selim':
    'Grains of Selim is known for its Warming, Decongestant, Digestive aid effects.',
  Yarrow: 'Yarrow is known for its Wound healing, Fever reduction, Digestive support effects.',
  Yohimbe:
    'Yohimbe is known for its Sexual stimulation, Increased arousal, Central nervous stimulation effects.',
  ...
  'Lesser Periwinkle':
    'Lesser Periwinkle is known for its Cognitive enhancement, Vasodilation, Memory support effects.',
  Mistletoe:
    'Mistletoe is known for its Immune regulation, Sedation, Nervous system balance effects.',
  'Voacanga africana':
    'Voacanga africana is known for its Altered perception, CNS stimulation, Dream enhancement effects.',
  'Sweet Acacia': 'Sweet Acacia is known for its Relaxation, Calming, Uplifting mood effects.',
  'Cramp Bark':
    'Cramp Bark is known for its Muscle relaxation, Menstrual relief, Sedative effects.',
  'Sweet Violet':
    'Sweet Violet is known for its Cough relief, Mild sedation, Uplifting mood effects.',
  'Chaste Tree Berry':
    'Chaste Tree Berry is known for its Hormone balance, PMS relief, Luteal phase support effects.',
  'Grape Seed':
    'Grape Seed is known for its Vascular support, Free radical scavenging, Skin protection effects.',
  'Stinging Nettle':
    'Stinging Nettle is known for its Joint support, Urinary flow, Histamine modulation effects.',
  'Cat’s Claw':
    'Cat’s Claw is known for its Immune support, Anti-inflammatory, Digestive aid effects.',
  ...
  Gorse:
    'Gorse is known for its Mood elevation, Hope restoration, Mild nervous system support effects.',
  Vervain: 'Vervain is known for its Stress relief, Menstrual support, Digestive calming effects.',
  'Valerian Root':
    'Valerian Root is known for its Sleep aid, Anxiety reduction, Muscle relaxation effects.',
  Mullein: 'Mullein is known for its Lung soothing, Cough relief, Anti-inflammatory effects.',
  'Indian Valerian':
    'Indian Valerian is known for its Sleep aid, Anxiety reduction, Mental calm effects.',
  'Five-Leaved Chaste Tree':
    'Five-Leaved Chaste Tree is known for its Pain relief, Anti-inflammatory, Respiratory support effects.',
  'Himalayan Valerian':
    'Himalayan Valerian is known for its Sleep aid, Mental calm, Muscle relaxant effects.',
  'Acacia Nilotica':
    'Acacia Nilotica is known for its Wound healing, Oral health, Diarrhea relief effects.',
  'Dwarf Nettle':
    'Dwarf Nettle is known for its Skin soothing, Detox support, Mineral boost effects.',
  'Blue Vervain':
    'Blue Vervain is known for its Stress relief, Mood regulation, Tension release effects.',
  Ashwagandha:
    'Ashwagandha is known for its Stress resilience, Energy balance, Hormonal support effects.',
  'Southern Prickly Ash':
    'Southern Prickly Ash is known for its Local anesthetic, Circulation stimulant, Nerve tonic effects.',
  ...
  'Corn Silk':
    'Corn Silk is known for its Urinary support, Anti-inflammatory, Kidney soothing effects.',
  'Sichuan Pepper':
    'Sichuan Pepper is known for its Tingling sensation, Digestive stimulant, Mild analgesia effects.',
  'Wild Jujube Seed':
    'Wild Jujube Seed is known for its Sleep promotion, Anxiety relief, Dream regulation effects.',
  'Shampoo Ginger':
    'Shampoo Ginger is known for its Skin and hair care, Topical anti-inflammatory, Digestive aid effects.',
  'Maconha Brava':
    'Maconha Brava is known for its Mild euphoria, Mental calm, Lucid dreaming effects.',
  'Northern Prickly Ash':
    'Northern Prickly Ash is known for its Local numbness, Circulation boost, Lymphatic stimulation effects.',
  'Twinleaf Zornia':
    'Twinleaf Zornia is known for its Relaxation, Mild psychoactive, Cough soothing effects.',
  'Toothache Plant': 'Toothache Plant is known for its Numbing, Tingling, Salivation effects.',
  'Bael Fruit':
    'Bael Fruit is known for its Digestive regulation, Gut lining protection, Mild calm effects.',
  Yopo: 'Yopo is known for its Euphoria, Visionary state, Dissociation effects.',
  'Hawaiian Baby Woodrose':
    'Hawaiian Baby Woodrose is known for its Psychedelic visions, Sedation, Time distortion effects.',
  Wormwood:
    'Wormwood is known for its Digestive stimulation, Lucid dreams, Mental clarity effects.',
  'Marshmallow Root':
    'Marshmallow Root is known for its Mucosal soothing, Cough relief, Gut lining protection effects.',
...
export const herbsBatch27 = [
  {
    name: 'Artemisia abrotanum',
    slug: 'artemisia-abrotanum',
    description:
      'Southernwood is a fragrant herb used traditionally as a stimulant, memory aid, and dream enhancer.',
  ...
  },
  {
    ...
    slug: 'heimia-salicifolia',
    description:
      'Known as Sun Opener, this herb was used by the Aztecs for visionary and divinatory purposes.',
    region: 'Mexico, Central America',
  ...
  },
  {
    ...
    description:
      'Brahmi is an Ayurvedic nootropic herb that improves memory, learning, and mental clarity.',
    region: 'India, Southeast Asia',
  ...
  },
  {
    ...
    slug: 'nymphaea-caerulea',
    description:
      'The Blue Lotus of the Nile, used historically for sedative, aphrodisiac, and euphoric effects.',
    region: 'Egypt, Africa',
  ...
  },
  {
    ...
    slug: 'justicia-adhatoda',
    description:
      'Also called Malabar Nut, this herb has traditional uses as a respiratory aid and mild sedative.',
  ...
  },
  {
    ...
    slug: 'tilia-europaea',
    description:
      'Common Linden, used in European herbalism for calming, dream-enhancing, and tension relief.',
    region: 'Europe',
  ...
  },
  {
    ...
    description:
      'Patchouli, while mainly aromatic, has mild psychoactive effects in traditional incense rituals.',
    region: 'Asia',
  ...
  },
  {
    ...
    description:
      'Source of vilca snuff; contains powerful tryptamines used in South American shamanism.',
    region: 'South America',
...
export const herbsBatch23 = [
  {
    name: 'Heimia salicifolia',
    slug: 'heimia-salicifolia',
    description:
      'Also known as Sinicuichi, this Central American herb is used traditionally to induce auditory distortions and mild euphoria.',
  ...
  },
  {
    ...
    slug: 'acorus-calamus',
    description:
      'Sweet Flag has a complex pharmacology: stimulant in low doses, sedative in high. Historically used in Ayurvedic and Native American medicine.',
  ...
  },
  {
    ...
    description:
      'Known as Siberian Motherwort, this herb is a relaxing nervine used in Asian medicine with mild psychoactive and aphrodisiac effects.',
    region: 'Siberia, China',
  ...
  },
  {
    ...
    description:
      'Also known as Epazote, used in Mesoamerican rituals. Contains CNS-stimulating compounds but is toxic at high doses.',
    region: 'Mexico',
  ...
  },
  {
    ...
    slug: 'casimiroa-edulis',
    description:
      'The fruit of the White Sapote tree is used as a sedative in traditional Mexican herbal medicine.',
    region: 'Central America',
  ...
  },
  {
    ...
    description:
      'Known as Partridgeberry, used as a uterine tonic and mild relaxing agent in North American herbalism.',
    region: 'North America',
  ...
  },
  {
    ...
    description:
      'Used in East Asian cuisine and medicine, this leaf contains mild mood-elevating and cognitive enhancing properties.',
    region: 'East Asia',
  ...
  },
  {
    ...
    description:
      'A variant of Damiana known for its aphrodisiac and mood-brightening properties. Traditionally used as a tonic.',
    region: 'Mexico',
  ...
  },
  {
    ...
    description:
      'Common thyme is a culinary herb with mild neurostimulant properties, thanks to its essential oils like thymol.',
    region: 'Europe',
  ...
  },
  {
    ...
    description:
      'Known as Imphepho in South African ritual use, this herb induces visions and is burned to invoke ancestors.',
    region: 'Southern Africa',
...
export const compoundsBatch3 = [
  {
    name: 'Thujone',
    type: 'monoterpene ketone',
    description:
      'A GABA receptor antagonist found in Mugwort and Wormwood, known for its psychoactive and convulsant potential.',
  ...
  },
  {
    ...
    type: 'terpenoid',
    description:
      'An aromatic terpenoid with mild stimulant and decongestant effects, present in Mugwort and other herbs.',
    foundIn: ['Artemisia vulgaris'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    description:
      'A bioactive component of Acorus species, structurally similar to psychoactive compounds and mildly sedative.',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'The primary alkaloid in Sceletium tortuosum (Kanna), acting as a serotonin reuptake inhibitor and mood enhancer.',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'A mood-lifting alkaloid in Kanna, shown to inhibit PDE4 and increase dopaminergic tone.',
    foundIn: ['Sceletium tortuosum'],
    psychoactivity: 'moderate',
  ...
  },
  {
    ...
    type: 'sesquiterpene lactone',
    description:
      'Bitter-tasting compounds in Calea ternifolia associated with oneirogenic effects.',
  ...
  },
  {
    ...
    type: 'saponin',
    description:
      'Bioactive glycosides found in dream herbs like Silene capensis, often linked to vivid dreaming.',
  ...
  },
  {
    ...
    description:
      'Aromatic oils in Tilia and other herbs that promote calm through olfactory and chemical pathways.',
    foundIn: ['Tilia tomentosa'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'phenylpropene',
    description:
      'A sweet-smelling compound with mild psychoactive effects, found in Tagetes lucida.',
  ...
  },
  {
    ...
    type: 'phenylpropene',
    description:
      'A mildly psychoactive aromatic compound found in herbs like Mexican tarragon and anise.',
    foundIn: ['Tagetes lucida'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'benzopyrone',
    description:
      'A fragrant compound with sedative and anticoagulant properties found in Justicia pectoralis.',
    foundIn: ['Justicia pectoralis'],
    psychoactivity: 'mild',
    mechanismOfAction: 'GABAergic modulation',
  },
  {
    ...
    type: 'coumarin derivative',
    description:
      'A bioactive coumarin compound found in Justicia pectoralis, with possible serotonergic action.',
    foundIn: ['Justicia pectoralis'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'glycoside',
    description:
      'Natural glycosides with foaming properties and mild relaxing effects, found in various dream herbs.',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'A nootropic compound found in Celastrus paniculatus (Intellect tree), used to improve memory and clarity.',
    foundIn: ['Celastrus paniculatus'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'One of the active components of Celastrus paniculatus, believed to promote alert calmness and mental energy.',
    foundIn: ['Celastrus paniculatus'],
    psychoactivity: 'mild',
...
export const herbsBatch28 = [
  {
    name: 'Artemisia ludoviciana',
    slug: 'artemisia-ludoviciana',
    description:
      'Also known as white sagebrush, used by Native American tribes for cleansing, dreams, and mild sedation.',
    region: 'North America',
  ...
  },
  {
    ...
    slug: 'turnera-diffusa',
    description:
      'Damiana is an aphrodisiac and mood enhancer used in Mexican herbal traditions and modern blends.',
    region: 'Mexico, Central America',
  ...
  },
  {
    ...
    slug: 'viola-odorata',
    description:
      'Sweet Violet, mildly sedative and anxiolytic, traditionally used for grief, tension, and calm dreams.',
    region: 'Europe, Asia',
  ...
  },
  {
    ...
    slug: 'petasites-hybridus',
    description:
      'Butterbur, once used for headaches and anxiety. Contains pyrrolizidine alkaloids — caution advised.',
    region: 'Europe',
  ...
  },
  {
    ...
    slug: 'zanthoxylum-clava-herculis',
    description:
      'The Toothache Tree, used for numbing, mild stimulation, and ritual practices in the American South.',
  ...
  },
  {
    ...
    slug: 'arundo-donax',
    description:
      'A tall reed containing trace tryptamines; rarely used, but investigated for its chemical potential.',
  ...
  },
  {
    ...
    slug: 'betula-lenta',
    description:
      'Sweet Birch, aromatic and uplifting; contains methyl salicylate, offering mild euphoria and clarity.',
    region: 'North America',
  ...
  },
  {
    ...
    slug: 'nepeta-cataria',
    description:
      'Catnip, while famous for feline effects, produces mild sedation and mood elevation in humans.',
  ...
  },
  {
    ...
    slug: 'scutellaria-lateriflora',
    description:
      'American Skullcap is a revered nervine herb promoting relaxation, calm, and sleep.',
    region: 'North America',
...
export const compoundsBatch7 = [
  {
    name: 'Thujone',
    type: 'monoterpene ketone',
    description:
      'A GABA receptor antagonist with stimulating and dream-enhancing effects, found in Artemisia species.',
  ...
  },
  {
    ...
    description:
      'A compound in Damiana believed to contribute to its aphrodisiac and euphoric effects.',
    foundIn: ['Turnera diffusa'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'sesquiterpene',
    description:
      'A compound in Butterbur used to relieve headaches and anxiety through smooth muscle relaxation.',
    foundIn: ['Petasites hybridus'],
    psychoactivity: 'mild',
    mechanismOfAction: 'Smooth muscle relaxant + serotonergic',
  },
  ...
  },
  {
    ...
    type: 'ester',
    description:
      'An aromatic compound with anti-inflammatory and uplifting properties found in birch and violet.',
  ...
  },
  {
    ...
    description:
      'Primary compound in Catnip with calming, euphoric, and slightly hallucinogenic effects in animals and mild effects in humans.',
    foundIn: ['Nepeta cataria'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'flavone glycoside',
    description:
      'A GABAergic flavonoid in Skullcap responsible for its calming and anxiolytic properties.',
    foundIn: ['Scutellaria lateriflora'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'tryptamine',
    description:
      'A powerful hallucinogenic compound found in trace amounts in Arundo donax and various entheogens.',
  ...
  },
  {
    ...
    type: 'tryptamine',
    description:
      'A powerful entheogenic compound, trace in Arundo donax, with visual and dissociative effects.',
    foundIn: ['Arundo donax'],
    psychoactivity: 'strong',
    mechanismOfAction: '5-HT2A receptor agonist',
  },
...
export const compoundsBatch6 = [
  {
    ...
    description:
      'A cooling aromatic compound with stimulating and mildly dissociative effects in high doses.',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'A psychoactive compound in Heimia salicifolia, associated with altered perception and lucid dreaming.',
    foundIn: ['Heimia salicifolia'],
    psychoactivity: 'moderate',
    mechanismOfAction: 'Serotonergic + anticholinergic',
  },
  {
    ...
    description:
      'Primary active nootropic agents in Bacopa, supporting memory, learning, and neuroplasticity.',
  ...
  },
  {
    ...
    description:
      'A main compound in Patchouli oil with grounding, relaxing properties in aromatherapy.',
  ...
  },
  {
    ...
    type: 'tryptamine',
    description:
      'A powerful psychedelic compound found in vilca and toad venom, causing intense visual effects.',
  ...
  },
  {
    ...
    description:
      'A calming antioxidant compound with potential mood-brightening effects found in Lemon Verbena.',
...
export const compoundsBatch2 = [
  {
    name: 'Cryogenine',
    type: 'alkaloid',
    description:
      'A sedating alkaloid found in Heimia salicifolia, known for its auditory distortion and calm-inducing properties.',
    foundIn: ['Heimia salicifolia'],
    psychoactivity: 'mild',
    mechanismOfAction: 'GABAergic modulation',
  },
  {
    ...
    type: 'phenylpropanoid',
    description:
      'A compound found in Acorus calamus with controversial stimulant and sedative properties depending on dose.',
  ...
  },
  {
    ...
    type: 'terpene',
    description:
      'A monoterpene peroxide in Epazote, responsible for stimulant and toxic properties at high doses.',
  ...
  },
  {
    ...
    type: 'terpene',
    description:
      'A naturally occurring aromatic terpene with stimulant and antioxidant properties.',
    foundIn: ['Dysphania ambrosioides'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'flavonoid',
    description:
      'A sedating flavonoid compound from Casimiroa edulis used in traditional medicine for insomnia.',
    foundIn: ['Casimiroa edulis'],
    psychoactivity: 'moderate',
  ...
  },
  {
    ...
    type: 'glycoside',
    description:
      'A class of plant glycosides with soothing and adaptogenic properties, found in Mitchella repens.',
  ...
  },
  {
    ...
    type: 'glycoside',
    description:
      'Bioactive compounds with anti-inflammatory and nervine properties, often used in traditional herbalism.',
    foundIn: ['Mitchella repens'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'terpenoid',
    description:
      'An aromatic compound found in Perilla leaf with uplifting and calming properties.',
  ...
  },
  {
    ...
    type: 'terpenoid',
    description:
      'A compound from Damiana associated with mood-enhancing and aphrodisiac properties.',
  ...
  },
  {
    ...
    type: 'polyphenol',
    description:
      'A broad group of antioxidant compounds with mood-modulating and sedative effects.',
  ...
  },
  {
    ...
    type: 'volatile blend',
    description:
      'A mixture of bioactive volatile compounds used in rituals and aromatherapy with psychoactive potential.',
...
export const compoundsBatch5 = [
  {
    name: 'Eugenol',
    type: 'phenylpropene',
    description:
      'A fragrant oil with calming and mildly euphoric properties found in allspice and clove.',
  ...
  },
  {
    ...
    type: 'sesquiterpene lactone',
    description:
      'A bitter compound in Wild Lettuce associated with sedative and analgesic effects.',
    foundIn: ['Lactuca virosa'],
    psychoactivity: 'mild',
    mechanismOfAction: 'Opioid receptor modulation',
  },
  {
    ...
    type: 'sesquiterpene lactone',
    description:
      'Mildly psychoactive compound in Wild Lettuce contributing to its calming effects.',
    foundIn: ['Lactuca virosa'],
    psychoactivity: 'mild',
    mechanismOfAction: 'Opioid receptor modulation',
  },
  ...
  },
  {
    ...
    type: 'iridoid glycoside',
    description:
      'A dopaminergic compound in Chasteberry thought to influence hormonal balance and mood.',
    foundIn: ['Vitex agnus-castus'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    description:
      'A compound in Amorpha fruticosa with unclear psychoactivity, possibly relaxing or trance-inducing.',
  ...
  },
  {
    ...
    type: 'glycosides',
    description:
      'A group of adaptogenic compounds found in Siberian Ginseng with neuroprotective properties.',
  ...
  },
  {
    ...
    type: 'iridoid glycoside',
    description:
      'A compound found in vervain, associated with sedative and spiritually clarifying effects.',
    foundIn: ['Verbena officinalis'],
    psychoactivity: 'mild',
    mechanismOfAction: 'GABAergic',
  },
...
export const compoundsBatch4 = [
  {
    name: 'Alpha-asarone',
    type: 'phenylpropanoid',
    description:
      'A psychoactive compound from Acorus species known for stimulant and cognition-enhancing effects.',
  ...
  },
  {
    ...
    type: 'tryptamine',
    description:
      'A potent serotonergic compound with fast-acting dissociative and mystical effects.',
    foundIn: ['Virola theiodora'],
    psychoactivity: 'strong',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'An alkaloid from Rue associated with sedative and possible antispasmodic effects.',
    foundIn: ['Ruta graveolens'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'flavonoid',
    description:
      'A bioflavonoid with anxiolytic and MAO-inhibiting properties found in Passionflower.',
  ...
  },
  {
    ...
    type: 'beta-carboline',
    description:
      'A reversible MAOI found in low levels in Passionflower, structurally related to compounds in Ayahuasca.',
    foundIn: ['Passiflora incarnata'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'A toxic yet psychoactive compound that acts on nicotinic receptors; found in Mescal bean.',
  ...
  },
  {
    ...
    type: 'alkaloid',
    description:
      'An alkaloid compound with neuroprotective and adaptogenic properties found in Desmodium.',
  ...
  },
  {
    ...
    type: 'triterpene',
    description:
      'Compounds with anti-inflammatory and tonic properties found in Desmodium species.',
    foundIn: ['Desmodium gangeticum'],
    psychoactivity: 'mild',
  ...
  },
  {
    ...
    type: 'ergoline',
    description:
      'Ergoline derivatives possibly present in Bindweed, structurally related to LSD precursors.',
  ...
  },
  {
    ...
    description:
      'A compound from clary sage with mild euphoria, possible hormonal modulation, and relaxing effects.',
    foundIn: ['Salvia sclarea'],
    psychoactivity: 'mild',
...
export const herbsBatch24 = [
  {
    name: 'Artemisia vulgaris',
    slug: 'artemisia-vulgaris',
    description:
      'Known as Mugwort, traditionally used in European and Asian cultures for vivid dreaming, menstrual relief, and mild psychedelic effects.',
    region: 'Europe, Asia',
  ...
  },
  {
    ...
    description:
      'Japanese Sweet Flag used in Shinto and Buddhist rituals, mildly stimulating and cognition-enhancing.',
    region: 'East Asia',
  ...
  },
  {
    ...
    description:
      'Known as Kanna, this South African succulent elevates mood and reduces anxiety. Used as a fermented chew.',
    region: 'South Africa',
  ...
  },
  {
    ...
    description:
      'Mexican Dream Herb used in lucid dreaming rituals by the Chontal people. Bitter but effective in inducing hypnagogic visions.',
    region: 'Mexico',
  ...
  },
  {
    ...
    description:
      'African Dream Root, revered by the Xhosa people for enhancing vivid and prophetic dreams.',
    region: 'Southern Africa',
  ...
  },
  {
    ...
    description:
      'Silver Linden, used as a calming tea in Europe. Shows sedative and anti-anxiety effects.',
    region: 'Europe',
  ...
  },
  {
    ...
    slug: 'tagetes-lucida',
    description:
      'Mexican Tarragon, used by the Aztecs and modern shamans as a mild psychedelic and incense.',
    region: 'Mexico',
  ...
  },
  {
    ...
    slug: 'justicia-pectoralis',
    description:
      'Known as tilo or chambá, this Amazonian herb is mildly relaxing and sometimes added to snuffs and brews.',
    region: 'Amazon basin',
  ...
  },
  {
    ...
    slug: 'entada-rheedii',
    description:
      'African Dream Bean, used to access ancestor spirits in dreams; seeds are large and traditionally worn as talismans.',
    region: 'Africa',
  ...
  },
  {
    ...
    slug: 'celastrus-paniculatus',
    description:
      'Intellect tree from Ayurveda; used to enhance memory and mental clarity, with mild stimulation.',
    region: 'India',
...
export const herbs = [
  {
    ...
    description:
      'A root bark source of DMT and other tryptamines traditionally used in Pacific Island cultures.',
    mechanismOfAction:
      'Contains N,N-DMT and related tryptamines; acts as a serotonergic psychedelic via 5-HT2A receptor agonism.',
    pharmacokinetics:
      'Inactive orally unless taken with an MAOI. Smoked or brewed in analog ayahuasca preparations.',
    ...
    contraindications:
      'Do not combine with SSRIs, MAOIs, or substances affecting serotonin. Not for use with heart or mental health conditions.',
    drugInteractions:
      'Strong interaction with MAOIs. Risk of serotonin syndrome with SSRIs or other psychedelics.',
  ...
  },
  {
    ...
    mechanismOfAction:
      'Tryptamine alkaloids (primarily N,N-DMT) act as 5-HT2A receptor agonists producing psychedelic effects.',
    pharmacokinetics:
      'Requires MAOI for oral activity; often used in ayahuasca analogues or vaporized.',
    ...
    contraindications:
      'Avoid combining with antidepressants, stimulants, or cardiovascular medications.',
  ...
  },
  {
    ...
    description:
      'A marshland rhizome used in Ayurveda and folklore for its aromatic and psychoactive properties.',
    mechanismOfAction:
      'Beta-asarone is a major active, possibly GABAergic and anticholinergic at high doses. Deliriant-like in excess.',
...
export const herbsBatch25 = [
  {
    name: 'Acorus americanus',
    slug: 'acorus-americanus',
    description:
      'American Sweet Flag, native to North America, used by indigenous groups for its psychoactive and stimulant properties.',
    region: 'North America',
  ...
  },
  {
    ...
    slug: 'virola-theiodora',
    description:
      'A South American tree whose resin contains potent tryptamines. Used in snuffs by Amazonian tribes.',
    region: 'Amazon Basin',
  ...
  },
  {
    ...
    slug: 'ruta-graveolens',
    description:
      'Common Rue, used historically as a sedative, an abortifacient, and for spiritual protection.',
    region: 'Mediterranean',
  ...
  },
  {
    ...
    slug: 'arundo-donax',
    description:
      'Giant Reed contains trace tryptamines and has been proposed as an Ayahuasca analog component.',
    region: 'Mediterranean, Asia',
  ...
  },
  {
    ...
    description:
      'Passionflower is a mild sedative and anxiolytic with MAO-inhibiting flavonoids. Common in herbal teas.',
  ...
  },
  {
    ...
    description:
      'Mescal bean, used ceremonially by Native American tribes. Highly toxic, formerly used as an ordeal poison.',
  ...
  },
  {
    ...
    description:
      'An Ayurvedic herb with antistress, adaptogenic, and cognitive benefits. Traditionally used to support vitality.',
    region: 'India, Southeast Asia',
  ...
  },
  {
    ...
    description:
      'A rare calamus variant high in beta-asarone, used in Tibetan medicine and ritual incense.',
    region: 'Himalayas',
  ...
  },
  {
    ...
    description:
      'Bindweed, a relative of morning glory, contains ergoline alkaloids and is under investigation for mild entheogenic potential.',
    region: 'Europe, North America',
  ...
  },
  {
    ...
    slug: 'salvia-sclarea',
    description:
      'Clary Sage, used aromatically and medicinally for mild euphoria, hormonal balancing, and clarity.',
    region: 'Mediterranean',
