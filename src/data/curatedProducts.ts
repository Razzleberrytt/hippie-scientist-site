...
export const curatedProductRecommendations: CuratedProductRecommendation[] = [
  ...
  },
  {
    ...
    confidenceTierRequired: 'low',
    cautionNotes: ['May increase sedation with CNS depressants.', 'Avoid during pregnancy unless clinician-directed.'],
    bestFor: ['Users who prefer powders over capsules', 'People who want mixable daily routines'],
    avoidIf: ['You need pre-measured fixed-dose servings', 'You are pregnant or breastfeeding without medical guidance'],
    featured: false,
    active: true,
    sortOrder: 2,
  },
  {
    ...
    confidenceTierRequired: 'low',
    cautionNotes: ['May increase sedation with CNS depressants.', 'Avoid during pregnancy unless clinician-directed.'],
    bestFor: ['Users who prefer tea over pills', 'Evening relaxation routines'],
    avoidIf: ['You need standardized extract potency', 'You take sedating medications'],
    featured: false,
    active: true,
    sortOrder: 3,
  },
  {
    ...
    bestFor: ['Users who want convenient daily capsule use', 'People tracking consistent intake over time'],
    avoidIf: ['You use anticoagulant or antiplatelet medication without clinician review'],
    featured: true,
    active: true,
    sortOrder: 1,
  },
  {
    ...
    confidenceTierRequired: 'low',
    cautionNotes: ['May increase bleeding risk with anticoagulant therapy.', 'Pause before surgery unless clinician-cleared.'],
    bestFor: ['Users who prefer liquid dosing', 'People avoiding capsule fillers'],
    avoidIf: ['You need single-step pre-measured servings', 'You use anticoagulant or antiplatelet medication without clinician review'],
    featured: false,
    active: true,
    sortOrder: 2,
  },
  {
    ...
    confidenceTierRequired: 'low',
    cautionNotes: ['May increase bleeding risk with anticoagulant therapy.', 'Pause before surgery unless clinician-cleared.'],
    bestFor: ['Users who prefer tea rituals', 'Lower-intensity onboarding'],
    avoidIf: ['You need concentrated per-serving extract potency'],
    featured: false,
    active: true,
    sortOrder: 3,
  },
  {
    ...
    bestFor: ['Users prioritizing capsule convenience', 'People seeking labeled curcumin serving consistency'],
    avoidIf: ['You are preparing for surgery', 'You use anticoagulant therapy without clinician review'],
    featured: true,
    active: true,
    sortOrder: 1,
  },
  {
    ...
    confidenceTierRequired: 'low',
    cautionNotes: ['Can interact with anticoagulants and antiplatelet medications.', 'May aggravate reflux in sensitive users.'],
    bestFor: ['Users who prefer liquid supplementation', 'People customizing serving size'],
    avoidIf: ['You are highly sensitive to alcohol-based extracts'],
    featured: false,
    active: true,
    sortOrder: 2,
  },
  {
    ...
    confidenceTierRequired: 'low',
    cautionNotes: ['Can interact with anticoagulants and antiplatelet medications.', 'May aggravate reflux in sensitive users.'],
    bestFor: ['Users preferring tea rituals', 'People starting with lower-intensity formats'],
    avoidIf: ['You need concentrated curcumin-per-serving dosing'],
    featured: false,
    active: true,
    sortOrder: 3,
  },
