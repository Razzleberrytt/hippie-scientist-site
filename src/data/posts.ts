...
export const posts: Post[] = [
  ...
  },
  {
    ...
    excerpt: 'Study how plant compounds interact with human biology.',
    content: `Phytochemicals influence our physiology in many ways. This module explains basic receptor binding, metabolism and synergistic effects seen in traditional remedies.`,
    date: '2024-07-16',
  },
  {
    id: 16,
    ...
    excerpt: 'Create tinctures, oils and other preparations at home.',
    content: `From simple alcohol tinctures to advanced solvent extractions, this lesson covers equipment, safety and step-by-step methods to capture active constituents from herbs.`,
    date: '2024-07-17',
  },
  {
    id: 17,
    ...
    excerpt: 'Explore adaptogenic fungi used for wellness and healing.',
    content: `Mushrooms like reishi and lion's mane contain beta-glucans and other compounds that support immunity and cognitive function. Learn proper identification and preparation.`,
    date: '2024-07-18',
  },
  {
    id: 18,
    ...
    excerpt: 'Analyze the molecular structures of visionary compounds.',
    content: `Dive into biosynthetic pathways and structural motifs that give psychedelics their unique properties. Understanding these basics illuminates how modifications change potency and effect.`,
    date: '2024-07-19',
  },
  {
    id: 19,
    ...
    excerpt: 'Survey theories that attempt to explain awareness.',
    content: `Philosophers and scientists propose various models of mind and perception. This overview touches on panpsychism, neurophenomenology and other frameworks relevant to psychedelic research.`,
    date: '2024-07-20',
  },
  {
    id: 20,
    ...
    excerpt: 'Understand the form and structure of botanical specimens.',
    content: `Recognizing leaves, stems and reproductive features helps differentiate species. Detailed diagrams guide you through key terminology used by botanists.`,
    date: '2024-07-21',
  },
]
