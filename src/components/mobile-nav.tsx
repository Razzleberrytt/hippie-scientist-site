            ...
            {links.map(link => {
              ...
              return (
                <Link
                  ...
                  className={`flex min-h-12 items-center rounded-2xl px-4 py-3 text-base font-black transition ${
                    isGoals
                      ? 'border-l-4 border-emerald-600 bg-emerald-50/50 text-emerald-800'
