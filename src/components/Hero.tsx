...
export default function Hero({ counts }: HeroProps) {
  ...
  return (
    <section className='relative mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-10'>
      <div
        aria-hidden
      ...
      <Tilt maxTilt={6} perspective={900} className='relative'>
        ...
        >
          ...
          <div className='relative space-y-5 p-5 sm:space-y-6 sm:p-10'>
            <motion.h1
            ...
            <motion.p
              ...
              className='max-w-2xl text-sm text-white/80 sm:text-lg'
            >
