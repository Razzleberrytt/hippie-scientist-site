...
export default function BundleUpgradeCard({
  ...
  return (
    <section
      className={`border-brand-lime/55 from-brand-lime/22 via-panel to-panel/95 relative space-y-4 overflow-hidden rounded-xl border bg-gradient-to-br p-4 shadow-[0_0_0_1px_rgba(163,230,53,0.18),0_16px_44px_-18px_rgba(163,230,53,0.95)] ${className}`.trim()}
    >
      ...
      <div className='relative z-10 space-y-4'>
        ...
        <div className='grid gap-2 rounded-lg border border-white/15 bg-black/30 p-3 text-sm sm:grid-cols-2'>
        ...
        <div className='space-y-2'>
          <Button
            ...
            className='border-brand-lime/55 bg-brand-lime/25 text-brand-lime hover:bg-brand-lime/35 w-full justify-center border shadow-[0_0_30px_-12px_rgba(163,230,53,1)]'
          >
            Upgrade to Bundle
          </Button>
