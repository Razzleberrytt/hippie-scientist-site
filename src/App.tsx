...
const HerbsPage = lazy(() => import('./legacy-pages/Herbs'))
const Favorites = lazy(() => import('./legacy-pages/Favorites'))
const BuildBlend = lazy(() => import('./legacy-pages/BuildBlend'))
const BlendView = lazy(() => import('./legacy-pages/BlendView'))
const NotFound = lazy(() => import('./legacy-pages/NotFound'))
import { RedirectHandler } from './RedirectHandler'
import { useGA } from './lib/useGA'
const HerbIndex = lazy(() => import('./legacy-pages/HerbIndex'))
const CompoundsPage = lazy(() => import('./legacy-pages/Compounds'))
const HerbDetail = lazy(() => import('./legacy-pages/HerbDetail'))
const Compare = lazy(() => import('./legacy-pages/Compare'))
const DataReport = lazy(() => import('./legacy-pages/DataReport'))
const DataFix = lazy(() => import('./legacy-pages/DataFix'))
const Sitemap = lazy(() => import('./legacy-pages/Sitemap'))
const Newsletter = lazy(() => import('./legacy-pages/Newsletter'))
const Contact = lazy(() => import('./legacy-pages/Contact'))
const Contribute = lazy(() => import('./legacy-pages/Contribute'))
...
const BlogList = lazy(() => import('./legacy-pages/BlogList'))
const BlogPost = lazy(() => import('./legacy-pages/BlogPost'))
const GraphPage = lazy(() => import('./legacy-pages/Graph'))
const Theme = lazy(() => import('./legacy-pages/Theme'))
const CompoundDetail = lazy(() => import('./legacy-pages/CompoundDetail'))
const StarterPackSuccess = lazy(() => import('./legacy-pages/StarterPackSuccess'))
const Downloads = lazy(() => import('./legacy-pages/Downloads'))
const LearningPaths = lazy(() => import('./legacy-pages/LearningPaths'))
const HerbGoalPage = lazy(() => import('./legacy-pages/HerbGoalPage'))
const GoalProfilePage = lazy(() => import('./legacy-pages/GoalProfilePage'))
const BestHerbsEntryPage = lazy(() => import('./legacy-pages/BestHerbsEntryPage'))
const Methodology = lazy(() => import('./legacy-pages/Methodology'))
const InteractionsPage = lazy(() => import('./legacy-pages/InteractionsPage'))
const CollectionPage = lazy(() => import('./legacy-pages/CollectionPage'))
const AnalyticsPage = lazy(() => import('./legacy-pages/AnalyticsPage'))
const PrivacyPolicy = lazy(() => import('./legacy-pages/PrivacyPolicy'))
const DisclaimerPage = lazy(() => import('./legacy-pages/DisclaimerPage'))
const UnknownCompoundSurvivalGuide = lazy(() => import('./legacy-pages/UnknownCompoundSurvivalGuide'))
