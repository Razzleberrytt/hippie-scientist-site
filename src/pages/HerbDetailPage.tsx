  ...
  return (
    <div className='mx-auto max-w-3xl p-4'>
      <h1 className='mb-6 text-3xl font-bold text-white'>
        {isValid ? herbName(herb) : herbs.length === 0 ? 'Loading…' : 'Herb not found'}
      </h1>
      <ErrorBoundary>
        {isValid ? (
          <HerbCardAccordion herb={herb} />
        ) : herbs.length === 0 ? (
          <div className='rounded border border-emerald-400/50 bg-emerald-500/10 p-4 text-center text-emerald-200 shadow'>
